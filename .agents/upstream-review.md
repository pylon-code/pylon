...
| C3         | `8eca20005`+`2a04db134` / `#5103`,`#5397` | adopted  | `294162a47`, `4596235d0` | Configurable interface/prompt/code/terminal fonts. **Adopted with upstream's default typography**, which drops the bundled DM Sans and JetBrains Mono in favour of system faces. Revisit by re-adding the `@fontsource` deps if the system default reads wrong.                                                                                                        |
