...
| Source                                              | Decision | Pylon rationale                                                                                                                                                                                                                                                                                                                                                                            |
| --------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ec44bc56f598be16ffbc22ed0e4e095447043844` (#9316)  | Skipped  | Preserve actual tool outcomes. Upstream deliberately describes a completed call as still running while its parent turn continues. Pylon's existing web and mobile lifecycle tests retain completed/failed/stopped wording; the prepared mobile Thinking row represents ongoing turn work separately. Keep unknown-state labels neutral and do not add the always-present-tense normalizer. |
| `e15ffb9c0f73425dd9a1965070f01a07c9065761` (#10303) | Skipped  | This document directs reports to T3's security inbox and T3-operated infrastructure policy, including another organization's disclosure and safe-harbor terms. Those contacts and terms are not Pylon's. Do not redirect Pylon reports to T3 or invent a Pylon address/policy. A future Pylon reporting policy is independent work, not an outstanding port of this T3-specific pointer.   |

Complete patches, PR descriptions and relevant review context were read. The work-log decision was compared against Pylon's existing lifecycle tests and the prepared #396 adaptation. The reporting pointer was checked against current Pylon documentation and repository reporting configuration; this review creates no new reporting channel or policy.

DEF-12 (#9989) and DEF-14 (#9976) were rechecked: `openTerminalLinkInPreview` still calls `isPreviewableUrl`, and web/native markdown parsing still calls `isConventionalFilePosition`. Their deletion patches cannot be applied while those callers remain. DEF-12 still depends on the separately reviewed terminal-link selector; the register conditions remain unchanged. Other deferred and watched work retains the same bounded-head assessment recorded above.
...
Release run `34118829461` failed its quality gate and did not publish. Replacement run `34121368130` passed all four platform builds and release quality checks and is publishing from the #395 merge. Publication and hosted web deployment are not yet claimed verified. The last fully verified Nightly remains `0.0.33-nightly.20260907.135`; no installed-app update is claimed.

## 2026-09-07 — tooling adoption, test-only follow-ups and verified Nightly (partial range)

Under the maintainer's standing approval, twelve sources landed in [#393](https://github.com/pylon-code/pylon/pull/393) at merge `782ca75796d3d3feac5dcd8dfbc8ec903feaedd5`, and six further sources are reconciled without a code port. Against bounded upstream head `062987b2fb0ef48cc7776d654931bd9f3bcf1f9f`, this leaves **275 remaining sources**, **101 adopted sources across 48 adoption PRs**, and **26 reconciled without a port**. Eight sources in prepared client PRs #383, #391 and #392 remain excluded from adoption counts. The full review cursor is unchanged.

| Adopted source                             | Upstream change                                                            |
| ------------------------------------------ | -------------------------------------------------------------------------- |
| `126ea5c3bcf888df4a918438ae7d68a4a4a905f2` | chore: configure Knip workspace audits (#9958)                             |
| `4a42fc62e15018973b0088667d037b2a35c4c261` | refactor(web): prune unused UI and provider code (#9959)                   |
| `00d46188bedfae81a5d219c8eba4b63e8cf90036` | chore: remove redundant root tooling dependencies (#9961)                  |
| `d2c3e2e5d7360b5d87f7516bdbce46b5c5444ef4` | ci: reject unused files and dependencies with Knip (#9962)                 |
| `cd92a7e7ae68a9b0c01938e1f69c2044b6c455ac` | ci: reject unused tailscale exports with Knip (#10012)                     |
| `4631000f5a7666c88402ce11a9ebb8cdef7a7dad` | ci: reject unused Codex client exports with Knip (#10036)                  |
| `62ed748ac94a73dca1b3eb99b1da52d71ebed247` | ci: reject unused SSH exports with Knip (#10145)                           |
| `5fe5c6fe9bb72c6e8ce9c1724a3887381d3f5cf7` | ci: enforce runtime exports while allowing types and schemas (#10171)      |
| `fdcc491e0b36245d4b4c74d1fd338d874f4ec84f` | refactor(web): remove unused runtime wrappers and exports (#10225)         |
| `226abe5f916ff828d8be2c19f1148b10feebfe43` | refactor(web): keep feature component helpers private (#10226)             |
| `1200f530bdc8be25ca1c85affa42b6d9c259601c` | refactor(web): keep app utilities private and remove dead helpers (#10227) |
| `da2ba5b81f8be6afc6d54e728bf4ac8781f3ab1c` | ci: enforce unused runtime exports in the web app (#10228)                 |

#393 adds pinned Knip 6.34.0 and CI gates for unused files, dependencies, and runtime exports. The TypeScript preprocessor exempts Effect schemas without evaluating modules, while ordinary unused runtime declarations still fail. Pylon-specific native loaders, maintainer commands, CI runners, branding dependencies, and Prime/RPC behavior remain intact. Unused wrappers are removed and internal helpers made private; exported types remain available.

DEF-13 is retired: #9959 is adopted with Pylon-specific adaptation. ColorSelector, PROVIDER_OPTIONS, and getProviderInteractionModeToggle intentionally remain because their Pylon provider-customization, Prime-picker, and composer callers are live. These retained deletions are a completed compatibility decision, not another outstanding source. Other deferred and watched entries retain their prior assessment.

Validation for #393: 708 focused tests, typechecks for scripts/contracts/client runtime/server/web/desktop/mobile, scoped lint/formatting and scoped Knip audits passed. All CI checks and the transfer-size report passed on exact head `d3d2c25404128bee704ea88dfa7e20f715235929` before merging.
...
Except for the retired DEF-13 entry above, the deferred and watched items retain the same bounded-head assessment recorded earlier. Native GitHub evidence uploads for the three verified client PRs remain blocked by the locked Mac; their code and client verification are complete.

Nightly `0.0.33-nightly.20260907.135` is verified from source `19c30d2d53868f663186b3b31123ffdcb06047df` in successful release run `34109926089`. All four platform builds, quality checks, publication of 15 Pylon assets, and hosted web deployment passed. This Nightly contains **89 of the 101 adopted sources**. The twelve sources in #393 require the next Nightly. No installed-app update is claimed.
...
| Upstream source                                                                                          | Decision           | Evidence and Pylon decision                                                                                                                                                                                                                                                                                                                                                       |
| -------------------------------------------------------------------------------------------------------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `da976cf2932f0f632c6e42f0adb604a7f058ac1c` (#10450), `bd280de80a5a39059918757c09af5ae9b7973a97` (#10454) | Skip reverted pair | The complete forward patch replaces T3 endorsement paging with duplicated continuous marquees and enables all Astro dev hosts. Its revert exactly undoes it: forward/inverse stable patch ID `af4edf38670052c7b4df4187f9a3fad0f235a832`; the pair's net tree diff is empty. Neither belongs in Pylon. The final replacement is assessed separately below.                         |
| `b22646c312a04033ac9da97d663422b83dbe7d0f` (#10455)                                                      | Skip               | Restores a gated T3 endorsement marquee after the revert. The final patch uses viewport/document visibility and reduced-motion gates, and hover/focus pause, but Pylon intentionally removed those T3 endorsements and retains static provider marks. It has no `tweets.ts` or `homeMotion.ts` caller to update. Preserve that product and performance decision.                  |
| `b2e15185aee22bfdee78806f2734b0a4de9c2c77` (#10286)                                                      | Skip               | Adds a separate Windows 95 parody landing page, 1,244 lines of page-scoped CSS, retro controls, T3-branded retail-box artwork, T3 adoption claims, and T3 legal/product links. This is an independent T3 marketing campaign, not a missing Pylon client capability. Keep Pylon's own homepage, artwork and truthful copy; do not import or rebrand the campaign as catch-up work. |
| `7e03dcfe5d405626a94037e19a18f9950162b3ea` (#10460)                                                      | Skip               | Changes only the unadopted `/95` page's Nightly link. The useful standard download-page channel feature (#10408) remains an independent candidate, with Pylon's public release repository and unpublished mobile apps requiring adaptation.                                                                                                                                       |
| `08c715ed93f8a6bfd85d42f5a8b7dbe12404554d`                                                               | Skip               | Only advances four upstream package versions from 0.0.38 to 0.0.39. Pylon owns its release numbering and publishes its own source-verified channels; importing a T3 version does not adopt any behavior.                                                                                                                                                                          |

All textual changes and changed-asset lists were read, with PR descriptions and relevant review context where a PR exists. The reverted pair was checked by inverse patch identity and its net tree diff. No source code, asset, compatibility identifier, deployment configuration or native dependency changes in this batch.

The deferred register and watch list retain the immediately preceding verified state at the same bounded head: DEF-8 product/navigation is due; DEF-7's November floor is unreached; DEF-11–15 still have live callers. WATCH-1 remains open/unmerged; WATCH-2 and WATCH-3 remain closed without replacements. No register row or owning issue changed.

Nightly `0.0.33-nightly.20260907.133` is verified from `f9235316408606e0cd3991b681a7fe5a7efc35ae` in successful run `34096803804`. All four platform builds, release quality checks, public release publication (15 assets), and hosted web deployment passed. It contains all **80 adopted sources** recorded above. This is a release verification, not a claim that an installed app was updated.

## 2026-09-07 — recovery and client ports, with marketing decisions (partial range)

The maintainer's standing approval covers these fourteen source commits across seven merged PRs. The active catch-up total is **80 adopted source commits across 39 adoption PRs**, including DEF-8's earlier development portion. A fresh fetch advanced the bounded upstream head from `6abdf37a50ce6c1c9fabc499f4d0e159a6182d90` to `062987b2fb0ef48cc7776d654931bd9f3bcf1f9f`, adding eleven candidates. After the three explicit marketing skips below, **308 sources remain to review or finish adopting**. This inventory includes possible skips and dependencies; it is not a count of required missing fixes. The full review cursor remains unchanged.

| Adopted concern                                      | Upstream sources                                                                                                                                                                                                           | Pylon implementation                                                                              |
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Release source selection                             | `7544d3d2c8e0145018d9adb7a1a650333b75362a`, `001f06d543beb92cc66bb7e8d54d233a20d802b4`                                                                                                                                     | [#374](https://github.com/pylon-code/pylon/pull/374) (`369c5fa51d026e0fc48ccb66a786558c4cd21d4c`) |
| Avoid unused legacy mobile list layout               | `7cf5b284e6e37895f535433c77f728b3e4292c9b`                                                                                                                                                                                 | [#351](https://github.com/pylon-code/pylon/pull/351) (`a6fa38b5ee155567c939eacd61186ca8c88f1980`) |
| Bound marketing image, animation, and font work      | `8e3aa324b57dd645980b203d5f8a5b9f9dc53a84`, `4ee2a9d046a0986451c703c9221bb32ba53540bb`, `010d6bb1b5281cb1e6eacf1ee0f2500973242836`                                                                                         | [#366](https://github.com/pylon-code/pylon/pull/366) (`f516db86493f80cf61e26b956938f5da3c208a34`) |
| Preserve POSIX case in file links                    | `8faf031c2dac4f147c43fe32e326b76678c20c94`                                                                                                                                                                                 | [#376](https://github.com/pylon-code/pylon/pull/376) (`d60ecd0c20273b9030f1015d7615e7adea559352`) |
| Keep private hosts out of favicon requests           | `b6f72681da394369274121c4d1216f5d64a7a4bb`                                                                                                                                                                                 | [#377](https://github.com/pylon-code/pylon/pull/377) (`e391b73b63dae53293796c5635d7a89cdaadc13f`) |
| Recover interrupted provider sessions after restarts | `5b7d72aad14ed37e8e5e4c02a6d49814bfe528ac`, `b906ce2d73d025e801877f42a35b7a2f5629806f`, `f47a3fe90354a3dfa14276e3699541d552426276`, `65f1839ae82af4e67f389f23e4ccc50f51a4a83f`, `1abc717f0dbd08027b5be4ec45ae6c5bccf96418` | [#358](https://github.com/pylon-code/pylon/pull/358) (`887809c8e5e2c403567c9be89b86cd1b584addc6`) |
| Explain Claude authentication and quota failures     | `3d00cfd5a710a58bf108de7a66fbe00a1420cc78`                                                                                                                                                                                 | [#361](https://github.com/pylon-code/pylon/pull/361) (`f9235316408606e0cd3991b681a7fe5a7efc35ae`) |

The restart series preserves Prime's separate daemon adoption and rollback fences, saves ordinary provider recovery markers through mixed-provider shutdown, and leaves automatic continuation off by default. All 433 focused tests and six affected package typechecks pass. In a disposable environment with providers disabled, the web setting saved on, survived a page reload and backend restart, and saved off again. The native iOS client displayed the new control and reflected both changes. Mobile verification remained read-only because other environments were saved in that test client. Actual provider recovery is covered by focused integration tests, not a real provider session.

Claude guidance passed 127 adapter/home-resolution tests and server typecheck. A disposable web fixture rendered the actual formatter's authentication text, its complete hover tooltip, and the quota message; no real authentication or quota failure was induced. POSIX file-link changes passed 116 focused tests, with before/after verification of the actual copy-relative-path action. Private favicon changes passed 123 tests; browser request interception confirmed private hosts stopped reaching the favicon service, while the public-host request remained. The shared host classifier preserves Pylon's existing policy exactly. Mobile favicon policy was tested and typechecked; no separate native favicon rendering pass is claimed.

The native mobile list check exercised the legacy switch on, list/search, and off again. Marketing build and Astro check passed; real browser measurements showed zero resting animations and zero external Google-font requests. Responsive Pylon artwork and local fonts remain. Release selection passed sixteen focused tests plus trigger-path checks and uses Pylon's separate public release repository, standard runners, and explicit nightly dispatch. Every adoption merged with green checks on its published commit. The PRs contain uploaded visual evidence where applicable.

| Source                                              | Decision | Pylon evidence and rationale                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `5d1b02cdeebff4b0b4f15a1e8425b06ae3cfe8d1` (#9385)  | Skipped  | Refreshes testimonials and avatars endorsing T3 Code. Pylon intentionally removed `apps/marketing/src/lib/tweets.ts` in branding commit `e48f4090d021ef63e776f0144414295c3dade6fa`; these are not Pylon endorsements.                                                                                                                                                                                                                               |
| `232de5e8aac61e6f3de4bc61d10746167db9e905` (#9547)  | Skipped  | Replaces T3's screenshot, statistics, provider copy, and animated hero ring. Preserve Pylon artwork, truthful product copy, and the static provider marks verified in #366. The Antigravity provider series remains a separate candidate; this marketing refresh does not establish provider support. The final patch's wrapper and inline-block fixes resolve its upstream review findings but do not make the T3 presentation suitable for Pylon. |
| `0860cea0c25f34582d03f17ccde23c5dfec64c12` (#10443) | Skipped  | Adds nightly-triggered production deployment to the `t3code-marketing` Vercel project because upstream disables Git deployment. Pylon explicitly enables Git deployment in `apps/marketing/vercel.ts` after its own branding/legal cleanup. Keep that independent deployment policy; do not add a second deployment targeting T3 infrastructure.                                                                                                    |

Complete textual patches, changed asset lists, PR descriptions, and relevant review context were inspected for these decisions. Other marketing sources, including the nightly download selector and Git-illustration accessibility fix, remain candidates rather than being swept into the branding skips.

Deferred/watch recheck at the fresh head: DEF-8's remaining product/navigation work is still due; its development portion is already recorded. DEF-7 remains not due before November 1, with no new preview-workflow changes. DEF-11 through DEF-15 retain live Pylon callers in the changed-files tree, terminal-link opener, provider customization, web/native markdown parsers, and PR opener. WATCH-1 (#8097) remains open/unmerged. WATCH-2 (#6573) and WATCH-3 (#7986/#7966) remain closed, with no new replacement path changes and their November revisit conditions unchanged. No owner issue changed state.

Nightly `0.0.33-nightly.20260907.132` was verified from source `369c5fa51d026e0fc48ccb66a786558c4cd21d4c` in successful release run `34091541653`, including all four platform builds, public release assets, and hosted web deployment. It includes 68 of the 80 adopted sources. A new explicitly nightly run, `34096803804`, has started from `f9235316408606e0cd3991b681a7fe5a7efc35ae` to include the remaining twelve; it is not yet claimed shipped. No installed app update is claimed.

## 2026-09-07 — settings, background work, and release review (partial range)

The standing approval for compatible adoption and routine Pylon adaptations covers these nine source commits across six merged PRs. The active catch-up total is now **66 adopted source commits across 32 PRs**, including the previously recorded older DEF-8 development source. This batch also reconciles five sources without new runtime code. Against the bounded upstream head `6abdf37a50ce6c1c9fabc499f4d0e159a6182d90`, **314 sources remain** to review or finish; this is not a count of required missing fixes. The full cursor remains unchanged.

| Adopted concern                                                | Upstream source                            | Pylon implementation                                                                              |
| -------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------- |
| Skip Git status scans while the index is locked                | `86070cbc7430957e542f5b1d4c6a38359329002d` | [#368](https://github.com/pylon-code/pylon/pull/368) (`660176009ce7a752f5c55109106cc3c9e2a88b8f`) |
| Follow a real checkout from a saved placeholder branch         | `1e740e48a5f91b3edd35c5446d33b0d36fb5a6ac` | [#369](https://github.com/pylon-code/pylon/pull/369) (`e8360fef5db3f478ff5988055ab409f21c328a7f`) |
| Preserve inline credentials on a masked provider settings save | `ac4f1a2b6d52b082edcc06d866892f8dcfdc033f` | [#370](https://github.com/pylon-code/pylon/pull/370) (`bf1ca61f9a01ca8efb9635b87d6dc30813326e4e`) |
| Skip settlement scans while both settings are disabled         | `d3d4ea42ee569f20d8a79562974355f659dc46d9` | [#371](https://github.com/pylon-code/pylon/pull/371) (`3caf6cbe9fc5798dcdbb49a29447f231e66cc082`) |
| Allow text-only agent browser snapshots                        | `29c5ecd0ee288489d254905dc6aa9844be36db8e` | [#372](https://github.com/pylon-code/pylon/pull/372) (`687e7f8a3af332832404e96cca844151d6cf5d26`) |
| Update UI reviewer model and budget                            | `3cd2cbbc115ac7d72fb52cc737fa64c547d6723e` | [#373](https://github.com/pylon-code/pylon/pull/373) (`3afec97ffdcc3d80317a1db0a539f7d0c9d085fd`) |
| Bound each Effect review run                                   | `f5a1ec5e29af6c898d86bfd96296734a0bcf476a` | [#373](https://github.com/pylon-code/pylon/pull/373) (`3afec97ffdcc3d80317a1db0a539f7d0c9d085fd`) |
| Normalize UI reviewer budget fields                            | `003289265f4cc7e5bfa0242aecce58e7150eed37` | [#373](https://github.com/pylon-code/pylon/pull/373) (`3afec97ffdcc3d80317a1db0a539f7d0c9d085fd`) |
| Normalize Effect reviewer budget fields                        | `d57bdf3843ef1871179207c0683d2eced72f9723` | [#373](https://github.com/pylon-code/pylon/pull/373) (`3afec97ffdcc3d80317a1db0a539f7d0c9d085fd`) |

Git lock handling was checked with 184 focused Git tests; placeholder checkout recovery with 44; provider secret preservation with 50; settlement with 29; and MCP snapshots with 34. Relevant regressions failed against the prior implementations. Affected server typechecks, targeted lint, formatting, and exact published-commit CI passed. Provider credential tests use Pylon's optimistic mutation API rather than bypassing its legacy-write rejection. Prime lifecycle and rollback authority, guarded thread metadata, active background work, and preview authorization remain intact. The reviewer configuration changes preserve Pylon's full review instructions and gates; their budgets and model selection are configuration adoption, not app behavior fixes.

| Source                                             | Disposition                | Current Pylon evidence                                                                                                                                                                                                                                                            |
| -------------------------------------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `b5a09e13fa464a8681e0bf9df404dd3c0afe8ac8` (#9250) | Already covered            | The temporary Expo Sharing 57.0.16 pin is superseded by Pylon's 57.0.17 patch and exact workspace override.                                                                                                                                                                       |
| `aab4049646ffa8b9bcff92562992e6c3a8554bf0` (#9248) | Already covered            | Pylon `872f0c573cb6768983d1e7bfc4b422f769732728` moved the patch and lockfile to 57.0.17; `7ab3fadf1d9dc36af26772cda0a900f3c6be879f` added the exact override. The current patch is byte-identical to upstream's final patch, and the lockfile resolves the same patched version. |
| `4ade365180231983008bcd46ca7312f8155e1224` (#9864) | Skipped                    | This rewrites Blacksmith's APT mirror file for browser-secret-helper install steps. Pylon uses GitHub-hosted standard runners and has no corresponding libsecret install steps. Preserve its existing package sources; reconsider if Pylon's runner downloads show failures.      |
| `535557b3f785629e6f48cad40c5a4b78b3b3c5d6` (#8808) | Skipped reverted precursor | The paired revert #9284 exactly undoes this patch: the forward and inverse stable patch IDs both equal `b0cc6b4d21bdd631b62c47179bb1ef6ad3fce9f3`. No precursor was ported to Pylon.                                                                                              |
| `63f334baf3432c4404ddfc9e71d33bf16575f0ed` (#9284) | Skipped paired revert      | The preceding feature/revert pair has no net implementation to adopt. The later replacement #9293 and its #9623/#10112 follow-ups remain review candidates; Pylon's Prime compaction controls must survive that integration.                                                      |

Complete patches and relevant PR descriptions/reviews were inspected for adopted and dependency changes; the reverted pair was reconciled as one zero-net change set with both PR descriptions and inverse patch identity. Oversized transcript import #10430 depends on the unadopted #5362 import wizard. Reset-credit retention #10308 depends on the unadopted reset-credit usage feature. Those fixes remain in the candidate inventory, rather than being treated as absent-code skips. Prepared client PRs #351, #358, #361, and #366 and release-source selection #374 are excluded from adoption counts.

Nightly `0.0.33-nightly.20260907.131` was verified against successful release run `34083287580` and source `2b26cb146577ef96c2805d0cfb4cfb930c066d2f`; it contains 40 of these 66 adopted sources. The remaining 26 require a later nightly. No installed application update is claimed.

## 2026-09-07 — provider failure reporting and fork-specific dispositions (partial range)

The maintainer’s standing approval for compatible ports and Pylon adaptations remains in effect. Three more source commits landed after the preceding 54-source batch, bringing the active catch-up total to **57 adopted sources across 26 code PRs**. Six additional sources below are explicitly reconciled as fork-specific skips or existing coverage. Against the same bounded upstream head `6abdf37a50ce6c1c9fabc499f4d0e159a6182d90`, **328 sources remain to reconcile**. The full review cursor is unchanged; these partial batches do not establish complete upstream parity or a shipped nightly.

| Source                                              | Decision        | Pylon implementation and verification                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| --------------------------------------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `6134b90ffb19c18e0b2f468aa172095a393470b0` / #10337 | adopted         | [#363](https://github.com/pylon-code/pylon/pull/363), merge `b3c385d52ca25ccc6b1b114e5dc3addcf7c63515`. Cursor’s standalone transport-error answers fail visibly instead of completing. Preserves session incarnation stamps; Pylon adaptation lets event draining finish when shutdown ends its consumer, avoiding the upstream patch’s deadlock in the existing pending-approval shutdown test. All 41 focused tests, server typecheck, lint, and exact-head CI pass. The new transport regression fails against the previous adapter. |
| `1c1d38fcd40252f91a3ea9056a7323135d3452dd` / #10458 | adopted         | [#364](https://github.com/pylon-code/pylon/pull/364), merge `607b5a9ea14538563ae2f27910deefdb08b91661`. Selects Codex’s main allowance and ignores Spark pushes using Pylon’s existing usage helpers and event decoder. Preserves machine-wide probe caching, per-instance state, retained readings, and sparse merges. All 129 focused tests, server typecheck, lint, and exact-head CI pass; all three new regressions fail on the previous implementation.                                                                            |
| `52b2bf77a941740b4d979f3f4cae1c2851c14a69` / #10446 | adopted         | [#365](https://github.com/pylon-code/pylon/pull/365), merge `0234070b32ff16b2685a2b6c9624ab029b9354d1`. Reads Claude’s final verbose result and unwraps JSON titles before normalization. Preserves Pylon configuration, remote execution, and context-compaction documentation. All 41 focused tests, server typecheck, lint, and exact-head CI pass. No live provider calls or saved-title migration.                                                                                                                                  |
| `44701efd6790c39dc82cb08104f7295e1780210f` / #9518  | skipped         | T3 repository hygiene forwards raw GitHub events to a separately configured Cursor automation using CURSOR_T3CODE_WEBHOOK_URL/AUTH and main. Pylon has no such workflow or adopted automation; preserve Pylon repository automation boundaries.                                                                                                                                                                                                                                                                                          |
| `e3723e06b5b154a3e0ede55c02e2cabc5301d3bf` / #9527  | skipped         | Removes comment triggers only from the intentionally unadopted T3 Cursor hygiene forwarder in #9518; no Pylon target.                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `95390ed78458f139cb795bab4baa53ec39222ff7` / #9557  | skipped         | Adds twelve upstream contributors to T3’s trust roster. Pylon owns .github/VOUCHED.td; preserve the fork-governance decision already recorded for #7728/#8071 and V20.                                                                                                                                                                                                                                                                                                                                                                   |
| `de28fa1ff3ac3c3a96bebd9ec5ce23dd09f61af0` / #10457 | skipped         | Enables automatic reviews in a CodeRabbit configuration absent from Pylon. Continues the recorded September 2 decision to skip the three upstream CodeRabbit configurations; no product fix to port.                                                                                                                                                                                                                                                                                                                                     |
| `d924fe266483e1d400775e3c3ce784f8e90f355f` / #10305 | already covered | Pylon already sets its canonical site origin, absolute canonical and Open Graph/Twitter image URLs, title and description, and a 1200x630 PNG share card. Keep the Pylon card and origin instead of generating a T3 screenshot card or advertising @t3dotgg. Verified apps/marketing/astro.config.mjs, src/layouts/Layout.astro, src/lib/site.ts, and public/og.png dimensions.                                                                                                                                                          |
| `fc1f543d6c67da9cf1edb25b647646faa0105b41` / #9912  | skipped         | Changes alignment only for T3’s endorsement carousel. Pylon’s homepage has no endorsement carousel or upstream testimonials; preserve its Pylon-owned marketing page.                                                                                                                                                                                                                                                                                                                                                                    |

Complete source patches and relevant PR context were reviewed. The marketing comparison confirmed Pylon’s own 1200×630 share card, canonical origin, and absence of a testimonial carousel. Pending restart continuation (#358), Claude failure guidance (#361), mobile list work (#351), and three website performance sources (#366) are excluded from adopted counts.

## 2026-09-07 — provider reliability and client performance catch-up (partial range)

The maintainer approved broad compatible adoption and routine Pylon adaptations, retaining a decision gate for changes that would undo important Pylon behavior. This batch records 54 newly adopted source commits across 23 merged PRs. Complete source diffs, PR descriptions and relevant reviews were read before porting. The bounded upstream head is `6abdf37a50ce6c1c9fabc499f4d0e159a6182d90`. The full review cursor stays unchanged: 337 source commits remain to reconcile against this head, including prepared work and potentially inapplicable changes. That inventory is not a count of required missing fixes.

The ports preserve Pylon's desktop identity and runtime home, Prime's provider behavior and rollback authority, provider-instance routing, mobile fingerprint policy, current UI controls, and remote connection modes. The Markdown and worker portions of #9799 share the already-counted source `ce4712d5b04fb998f79fe132245289191147e5d5`; they are additional completed portions, not two new source commits. DEF-8's development portion contributes one older source outside the cursor range; its remaining product work stays in the register.

Focused verification and exact commit checks are recorded on each PR. Integrated client verification passed 454 focused tests and client-runtime, web, and mobile typechecks. A disposable populated web environment and a rebuilt iOS development client covered navigation, thread rendering, large source and review views. Browser instrumentation measured ordinary-chat workers falling from six to zero, reuse across quick file-view reopening, expiry after 30 idle seconds, and initial historical image URL requests falling from 21 to six in a 20-image fixture. Markdown details and wrapping survived synthetic streaming; an ongoing-stream focus check retained its control. The Windows fixture batch passed 874 local focused tests and 322 tests in manual Windows jobs. OpenCode inventory regression tests reject the previous three-process overlap and verify both sequential passes. No physical-device or mobile OTA release is claimed here.

The restart-continuation batch (#358), Claude failure guidance (#361), and legacy-list optimization (#351) are prepared separately and are not included in these adoption counts. The complete upstream range and the remaining deferred product work are still under review. This record does not claim that a nightly containing this entire batch has shipped.

| Adopted upstream concern                                                       | Source commit                              | Pylon PR                                             |
| ------------------------------------------------------------------------------ | ------------------------------------------ | ---------------------------------------------------- |
| perf(shared): skip duplicate PATH entries and per-probe tracing (#9618)        | `c3caceade14ccda0686db0031aca79d7d38a71d0` | [#336](https://github.com/pylon-code/pylon/pull/336) |
| fix(codex): show what a file-change approval will change (#8669)               | `57a6b70e24221f00c9a161f1e5b6b2ddd753bc8f` | [#337](https://github.com/pylon-code/pylon/pull/337) |
| fix(server): remove retired Codex models after refresh (#9773)                 | `bfef973d9ec64e580fff4197ac53085207471ffd` | [#338](https://github.com/pylon-code/pylon/pull/338) |
| perf(client): stop thread streams when unused (#9740)                          | `d7cf8aaa8d4fbcbdd523b4f4bc86fda5c47b4a70` | [#339](https://github.com/pylon-code/pylon/pull/339) |
| fix(client): keep warm thread resumes live instead of flashing sync (#9913)    | `f87ecf0cc307f974745da8eea856fab5711023f3` | [#339](https://github.com/pylon-code/pylon/pull/339) |
| perf(server): avoid full patches for checkpoint summaries (#9694)              | `c163d502dd32b993c03d8c20a5fae55b159bd8dc` | [#340](https://github.com/pylon-code/pylon/pull/340) |
| fix(mobile): reduce dev-client reload and Metro startup cost (#8694)           | `1f8ed54add4133ac39effceded8fc1fff12d8e03` | [#341](https://github.com/pylon-code/pylon/pull/341) |
| refactor(server): share Claude result status and error mapping (#10296)        | `4c7cd17a832269ef17edcf99e987ac25ae1b640a` | [#342](https://github.com/pylon-code/pylon/pull/342) |
| perf(web): keep Markdown mounted during streaming (#9677)                      | `887ece307131bdc853cc10f3b82067dee77c4ecf` | [#343](https://github.com/pylon-code/pylon/pull/343) |
| fix(server): stop Windows terminal polling from spiking CPU (#9476)            | `ea646c0834a3394ecb0be4a30c5d367e5a9002bd` | [#344](https://github.com/pylon-code/pylon/pull/344) |
| perf(mobile): bound diff syntax highlighting work (#9673)                      | `3b6be3ef4daa848e10c095d8a088064ac836be7f` | [#345](https://github.com/pylon-code/pylon/pull/345) |
| fix(mobile): keep highlighting review diffs after a long line (#9911)          | `50027bb3ad2912f9127304392a2c85ad5ab9a4ba` | [#345](https://github.com/pylon-code/pylon/pull/345) |
| perf(mobile): reuse diff rows during comment edits (#9693)                     | `777f5bb2e11fe30e7fdcb5741b0b1d9bb20924d6` | [#346](https://github.com/pylon-code/pylon/pull/346) |
| perf(mobile): bound the parsed review cache (#9749)                            | `d6e29dc9dee943b34d6b0d11441fa944c7bff7c9` | [#346](https://github.com/pylon-code/pylon/pull/346) |
| perf(mobile): defer file preview highlighter startup (#9752)                   | `77b655c47b82c9b2aad09e447117b7618a16e21d` | [#347](https://github.com/pylon-code/pylon/pull/347) |
| perf(mobile): reuse chat feed rows during streaming (#9688)                    | `44dc8ae259f5c3349f7ab8045e39bd62408b52a9` | [#348](https://github.com/pylon-code/pylon/pull/348) |
| test(desktop): cover WSL paths through public behavior (#10289)                | `0c200c5f83c039f85da0cb1b8d1611db3e708c92` | [#349](https://github.com/pylon-code/pylon/pull/349) |
| test(desktop): cover password store through startup (#10287)                   | `181e45110f2d14950a5c1ec415faf3a049cb9b2e` | [#349](https://github.com/pylon-code/pylon/pull/349) |
| test(desktop): cover Clerk setup through the service (#10284)                  | `76f686d03456539f41ef295f0071fecb5df08921` | [#349](https://github.com/pylon-code/pylon/pull/349) |
| test(desktop): exercise WSL cache safety through public scripts (#10301)       | `b4040d9bf38d57cce715c9e602de8de4b0f4a523` | [#349](https://github.com/pylon-code/pylon/pull/349) |
| test(desktop): cover WSL hashes through runtime resolution (#10285)            | `cabac780f5d9566ea26d340c9f126a46664b698b` | [#349](https://github.com/pylon-code/pylon/pull/349) |
| refactor(web): test formatted timestamps instead of formatter options (#10221) | `585ce2c2ab396e4c3c5ffcfc422449c07896ddf9` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| refactor(web): test favicon fallback through the component (#10220)            | `748fe0f8b68b7951df6797d4c22d2ca01314a3dc` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| refactor(web): test file cache identity through its public helpers (#10219)    | `88fc41c1b90ff21a7d30d69e0ebffbc0c3511b9c` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| test(web): focus command palette tests on search behavior (#10302)             | `a9fc4dc2b010db7979dee9d11c94580fee62b44d` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| test(web): keep Markdown gutter styling private (#10306)                       | `b972f1c1dfc827c2fb074af92f52a9f8fc1fcda5` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| test(web): keep settings viewport comparison private (#10307)                  | `f1e84c28fe5982ecb507f4c934acf7a1a7b253b7` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| test(web): cover file classification through diff ordering (#10304)            | `f93aafcc2c166128070b32259e827f15bc2a1d82` | [#350](https://github.com/pylon-code/pylon/pull/350) |
| fix(release): install the correct Windows Spectre component (#9859)            | `1665d81bb5d78f33be6734e8962297b369396ac3` | [#352](https://github.com/pylon-code/pylon/pull/352) |
| refactor(shared): remove unused runtime helpers and exports (#10166)           | `0671e34279d42faf69fccfd46ceae305ccfa7c6d` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| refactor(contracts): keep unused settings and relay exports private (#10170)   | `2ae3b712b4b7dc7a3f44e9ceff404dfe1572ab93` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| refactor(ssh): keep package internals private (#10144)                         | `3fbc497b764ed904c4e50655da5b7a722d611fe5` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| refactor(contracts): trim unused client API runtime exports (#10169)           | `50bc62a83d2b5f4530b26e59095a74a48047c309` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| refactor(contracts): keep RPC implementation exports private (#10168)          | `5716dec97e4eaefea59369b07a8d54191fc33e31` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| refactor(acp): keep protocol implementation exports private (#10165)           | `cb9a6942363ed7f097c7d1fb075bf3a265fbf5d2` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| refactor(client-runtime): remove unused runtime exports and helpers (#10167)   | `dbfd5173131deb1a7ad2a9438b8941ade43f9a89` | [#353](https://github.com/pylon-code/pylon/pull/353) |
| perf(web): defer diff workers until a code view opens (#9692)                  | `b3e1d88590489da2bb63b95c18a57e6f400b8b7f` | [#354](https://github.com/pylon-code/pylon/pull/354) |
| perf(web): defer image URL requests for thread history (#9760)                 | `15eda897d37aad232fca5089f5eb6ef7b726c31c` | [#355](https://github.com/pylon-code/pylon/pull/355) |
| perf(web): reuse timeline rows while text streams (#9725)                      | `19c1710a88a2c87c159d76269dacdf0b17ddd9f4` | [#355](https://github.com/pylon-code/pylon/pull/355) |
| perf(web): keep timeline row reuse engaged while text streams (#9909)          | `aefef95ffc34eb76c8e2db9a219b86681f644576` | [#355](https://github.com/pylon-code/pylon/pull/355) |
| ci: add on-demand Windows test workflow (#9538)                                | `f96a220b5b154ea44c94bf43929c6362cd511699` | [#356](https://github.com/pylon-code/pylon/pull/356) |
| test(scripts): keep Windows packaging checks host-portable (#9589)             | `0a590fa01af66ec135d2ebf2d5542b08a37dc275` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test: skip POSIX mode-bit assertions on a Windows host (#9571)                 | `1108be0fc862d5a95374bf0b96518a20e6351025` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test(server): pin git config for fixtures and compare native realpaths (#9570) | `12b6d026bdfba0cc8438fa5e323a8587d65bd2af` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test: skip symlink fixtures where the host cannot create symlinks (#9566)      | `30f128fababb1fea46041d228b6ea52733d2ee09` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test(server): skip posix executable fixtures on a Windows host (#9565)         | `4701041eef6339bbda0d9d9b00a929c4e9e18662` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test(server): run fake provider CLIs through a Node stub on every host (#9567) | `5c6c1d67d82bb81bddaee6d83e54e8aecd96ec7d` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test(server): keep provider fixture directories host-portable (#9572)          | `9af5139f5974281a59f5cd62c11d918d62126313` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test: resolve the Windows temp directory to its long name (#9573)              | `9fa54eeb4c481b444c68e38d00066d707af5f677` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test(server): make Windows path and async fixtures deterministic (#9576)       | `b123cbb317ca47ff080a15b44c4bc0c99126f729` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test(desktop): make path fixtures and timeouts host-portable (#9568)           | `c251e41b5e5287b786cda44ddc263b8e6a74859c` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| test: stop path and platform tests depending on the host OS (#9564)            | `cc60753aa2279722149e182fb942ca87f70ff804` | [#357](https://github.com/pylon-code/pylon/pull/357) |
| fix(codex): accept misalignment policy errors on thread resume (#10373)        | `95139254ba98fb8ad12a001ebcbc9d4b833ead19` | [#359](https://github.com/pylon-code/pylon/pull/359) |
| fix(server): run OpenCode CLI commands sequentially (#10427)                   | `9ab0635db6abb1abf15e664141a0f8b6f0c33eae` | [#360](https://github.com/pylon-code/pylon/pull/360) |

| Pylon PR                                             | Verified merge commit                      |
| ---------------------------------------------------- | ------------------------------------------ |
| [#336](https://github.com/pylon-code/pylon/pull/336) | `16c999a985236c68abbc096bf33e14d313fb6103` |
| [#337](https://github.com/pylon-code/pylon/pull/337) | `07a269aaaf833d95b54f5793ef4a74936c8e9b35` |
| [#338](https://github.com/pylon-code/pylon/pull/338) | `a438388fb9e0652603ac686c9e593f158c125f09` |
| [#339](https://github.com/pylon-code/pylon/pull/339) | `2b26cb146577ef96c2805d0cfb4cfb930c066d2f` |
| [#340](https://github.com/pylon-code/pylon/pull/340) | `0da163382c6ecc8f4bb6898db340462273481097` |
| [#341](https://github.com/pylon-code/pylon/pull/341) | `665a493df835bbfaedb5f4df95d9d772ddadba33` |
| [#342](https://github.com/pylon-code/pylon/pull/342) | `5c057f9a91ac8634406da2cba509bbc2eeb766ce` |
| [#343](https://github.com/pylon-code/pylon/pull/343) | `e12ff8a80d198ddcf2b3091c13a643fd51eea14b` |
| [#344](https://github.com/pylon-code/pylon/pull/344) | `839aae13aac816c9c1f9cdc9d89709de3e710d51` |
| [#345](https://github.com/pylon-code/pylon/pull/345) | `3ab2900baf541906b7ed2cc1de59414add1797d5` |
| [#346](https://github.com/pylon-code/pylon/pull/346) | `2e05c69aae2ac944ab24f6ba89d4dda3c750dba2` |
| [#347](https://github.com/pylon-code/pylon/pull/347) | `007c9b9b15f360ffbdb1a920bae23239790f7583` |
| [#348](https://github.com/pylon-code/pylon/pull/348) | `24a5fe1c61f4b212cc182ed0733903e4b227a5db` |
| [#349](https://github.com/pylon-code/pylon/pull/349) | `3381f78f3b1be7d2d74f4b27519d9986da9a9116` |
| [#350](https://github.com/pylon-code/pylon/pull/350) | `98268e04b51e7091845b107af2835a45f5359dfc` |
| [#352](https://github.com/pylon-code/pylon/pull/352) | `90a4bc87263aac2fb1904f9ec6c289f710a7d2ae` |
| [#353](https://github.com/pylon-code/pylon/pull/353) | `2b283e2414fd9660f3801d3faa4b1830c8342883` |
| [#354](https://github.com/pylon-code/pylon/pull/354) | `34f96fa4b979655decaf430560988cb3cd1a7cfa` |
| [#355](https://github.com/pylon-code/pylon/pull/355) | `10f7b1e8d6c9daa2d50e7f83f81664aba8ad757f` |
| [#356](https://github.com/pylon-code/pylon/pull/356) | `58db27acb3c40cdc6cf5d76d67abd0f3a935decc` |
| [#357](https://github.com/pylon-code/pylon/pull/357) | `e583de372f7918383343276e060092de14331de3` |
| [#359](https://github.com/pylon-code/pylon/pull/359) | `ad5d597140a5ab03c88d2a25eccf9476375ce2e2` |
| [#360](https://github.com/pylon-code/pylon/pull/360) | `c3f224fcd120904547598dd4e69b07c795795e56` |
...
Verification: the same-size/same-timestamp HTML regression failed with a stale 304 before the correction. All 174 server routing tests pass after integration, including atomic file replacement, GET/HEAD/304/cancellation handle cleanup, manifest lookalikes, authentication, and live streams. Server and web typechecks, targeted lint, formatting, and diff checks pass. Merged in [Pylon #334](https://github.com/pylon-code/pylon/pull/334) as `89d36dd3fd2a9ff0d124d23c94d5e0ab2f184117`. Implementation branch: `upstream/2026-09-06-static-response-caching` based on `origin/pylon` at `1e7ffff246bf6ad4c31236e6b242a91d5c2275b0`.

## 2026-09-06 — broad approved reliability and performance adoption (partial range)

The maintainer authorized broad adoption of compatible changes and routine Pylon adaptations, reserving new decisions for changes that would undo important Pylon behavior. Complete source patches, upstream PR descriptions and relevant reviews were examined before each port. This review covers the bounded 614-commit ancestry range ending at `223ff4490f764a74ff911589e97b9bbcd595fee8`; the full cursor stays unchanged because unclassified work remains.

This catch-up has merged 148 source commits beyond the earlier 25: 61 reliability/performance changes below, 85 cleanup changes in the two cleanup records, and two static-response/live-stream source commits (#9669 and partial #9799) in their separate records. #9799 is counted once across both ports. Upstream #9485 was already present and is excluded. Pylon #331 fixes the web worker test teardown found by CI; it is not counted as an upstream adoption. A source commit counted here can be a selective port: #9784 supplies only confirmed PR-merge state handling, and #9537 supplies draft PR presentation, with unrelated changes excluded.

All 146 changes in the table and cleanup records are merged across Pylon #307–#330 and #332. The static response change merged in [Pylon #334](https://github.com/pylon-code/pylon/pull/334) as `89d36dd3fd2a9ff0d124d23c94d5e0ab2f184117`. The additional live-stream fix is merged in [Pylon #333](https://github.com/pylon-code/pylon/pull/333) as `1e7ffff246bf6ad4c31236e6b242a91d5c2275b0`. The four final client PRs (#312, #323, #324, #325) merged after evidence upload and green CI. Merge records and attached evidence are authoritative; this count does not claim every upstream commit in the 614-commit range is adopted or that the installed app has updated.

Pylon-first decisions: preserve Prime restart admission and recovery, checkpoint anchors and durable rollback, provider identities and installer ownership, Pylon desktop/runtime identity, existing preview recordings and panel tabs, and mobile native compatibility. New branch-PR persistence uses Pylon migrations 054 and 055 after its existing sequence; retired migration 36 stays retired. Automatic branch-PR refresh rechecks thread/workspace identity, keeps manually linked PRs distinct, and does not add automatic git pulls. Relay credential renewal keeps healthy sockets alive and scopes each refresh to its environment/account. Terminal output remains bounded and shares rollover-safe snapshots between clients.

Validation combines focused behavior tests, affected package typechecks, targeted lint, and green PR CI. Client evidence is attached to each visible-change PR, including baseline/candidate screenshots and videos where timing changed. The integrated client uses disposable Pylon state with providers disabled; renderer fixtures supply remote connection errors, preview IPC, and branch-PR snapshots. Real pairing creation/listing is exercised against the sandbox server. Windows/Linux behavior is additionally checked by CI. No physical-device build, installed-provider update, or installed-app restart is claimed.

| Upstream change                                                                               | Source commit                              | Implementation record                                      |
| --------------------------------------------------------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| perf(server): stop rebuilding terminal history per chunk (#9703)                              | `3bbbc1d9fd8b3d649c60ba0137c7dae93a6aab3f` | [Pylon #308](https://github.com/pylon-code/pylon/pull/308) |
| perf(server): bound terminal history by bytes (#9748)                                         | `cf9729d5ee9660c08556e823080d3bb19648ed28` | [Pylon #308](https://github.com/pylon-code/pylon/pull/308) |
| fix(server): advertise truecolor in the integrated terminal (#7680)                           | `89ee69e4430b21ee14565abf5c34dae43f38c1d8` | [Pylon #308](https://github.com/pylon-code/pylon/pull/308) |
| perf(web): stop replaying terminal buffers on rollover (#9707)                                | `da7e46d08e85bcb07ecd78721a40f7b612fac2f2` | [Pylon #308](https://github.com/pylon-code/pylon/pull/308) |
| perf(web): speed up terminal snapshots (#9663)                                                | `cccd7e3c885065e925f559c5708378cdb3b51eb3` | [Pylon #308](https://github.com/pylon-code/pylon/pull/308) |
| perf(server): stop retaining unused OpenCode tool history (#9684)                             | `f2e3764c257a7e27c8171d7dd1e38d4383074206` | [Pylon #307](https://github.com/pylon-code/pylon/pull/307) |
| perf(server): stop caching unused OpenCode tool parts (#9738)                                 | `c8f77e0d441264efb0acfac312e852c81ae3da83` | [Pylon #307](https://github.com/pylon-code/pylon/pull/307) |
| perf(server): omit repeated OpenCode progress logs (#9689)                                    | `ec8b2119c377f5c1dbe6235b221ef98eca31a96e` | [Pylon #307](https://github.com/pylon-code/pylon/pull/307) |
| perf(server): stop scanning old OpenCode parts (#10116)                                       | `281b92b48810062275798dd4107364384ebaf432` | [Pylon #307](https://github.com/pylon-code/pylon/pull/307) |
| perf(server): stop loading message bodies for thread summaries (#9662)                        | `8ac5462920c45cdee63af15b2598909736f2ec84` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): use one query for buffered provider events (#9706)                              | `dffb4cd3b16dc6f41aced99922950ee3083082c6` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): replay only the selected thread (#9726)                                         | `50bfca43d76ced00f5d67cfbab8bc44c50eb0e53` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): skip history reads for metadata commands (#9758)                                | `6365919f2e5bcfb4fa4020b95e19af26ae40979f` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): avoid full thread reads on turn start (#10108)                                  | `17490c0a00a6cf9a542fc8fa5d85f489fa662e70` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): skip plan bodies in thread summaries (#10341)                                   | `eb8ed80300bd719b49fc80ad8708f9839bb48c92` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): finish runtime messages without full thread reads (#10120)                      | `e4e9fa9a0b1a77e393ab6cffd75ec22dbb258bdc` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| perf(server): batch projector cursor writes (#9671)                                           | `2263e13fda8c9a4f1b6f4dee32e3c9020195e2aa` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| fix(server): include SQLite conditions in persistence errors                                  | `dddc0bdcb2230147e207efb17df2e49dbe1bdd8c` | [Pylon #314](https://github.com/pylon-code/pylon/pull/314) |
| fix(server): reveal normalized paths in File Explorer (#9551)                                 | `617edab6539ee6573055dc9fc45fdeacdb12f673` | [Pylon #313](https://github.com/pylon-code/pylon/pull/313) |
| fix(server): canonicalise media paths the same way their callers do (#9575)                   | `5f4c7161fa7782ea93b63fe934d43229742e7ec8` | [Pylon #313](https://github.com/pylon-code/pylon/pull/313) |
| fix(server): refuse symlinked theme files on Windows too (#9580)                              | `781f41ef1f6b5054e75f77237df9eba3b7f61cc9` | [Pylon #313](https://github.com/pylon-code/pylon/pull/313) |
| fix(server): skip disabled provider instances for text generation fallback (#10346)           | `62f568b88b58e1e7cf422c21ee2e08f10977b714` | [Pylon #315](https://github.com/pylon-code/pylon/pull/315) |
| fix(server): install pinned runtime when pnpm node lacks npm (#9923)                          | `311f05c8e333a9f7adfbbf5681b849888670d00a` | [Pylon #316](https://github.com/pylon-code/pylon/pull/316) |
| fix(ssh): report remote stop failures without losing ownership (#10105)                       | `60e6fa30c3a8c1e17ba7fb80e5f85f44a0cd2693` | [Pylon #319](https://github.com/pylon-code/pylon/pull/319) |
| Fix worktree removal timing out on large install trees (#3902)                                | `f54ab901fa77f76eeb1e1cdfa103b9ed6f5ee4ca` | [Pylon #318](https://github.com/pylon-code/pylon/pull/318) |
| fix(server): keep a/ and b/ prefixes in rendered git patches (#9438)                          | `36c4e9cf5c0123e33d65f2af9497ee090404b532` | [Pylon #317](https://github.com/pylon-code/pylon/pull/317) |
| fix(connect): refresh authorization without disconnecting (#9582)                             | `39abb9d1d6ae6501c573b9dc0cb9c28e2f75659c` | [Pylon #320](https://github.com/pylon-code/pylon/pull/320) |
| perf(clients): avoid waiting to read cached relay tokens (#9691)                              | `246064993535e5d90107d3d7784ceef3cc883435` | [Pylon #320](https://github.com/pylon-code/pylon/pull/320) |
| fix(connect): refresh HTTP credentials without reconnecting (#9594)                           | `363cde4114c2186c496ed97cafba4a8737ea5585` | [Pylon #320](https://github.com/pylon-code/pylon/pull/320) |
| fix(server): prevent duplicate desktop clients after restart                                  | `eb77683e5544e071db74831bae052bbd8a7d5f88` | [Pylon #322](https://github.com/pylon-code/pylon/pull/322) |
| fix(auth): keep pairing credentials out of access read models (#9523)                         | `9d28c21a26aeef198cb064fe466e49cbeabfe09c` | [Pylon #323](https://github.com/pylon-code/pylon/pull/323) |
| fix(connect): diagnose incomplete headless server setup (#9602)                               | `99e3b721c5255ded20b00ba1798f848bfc0f1f65` | [Pylon #321](https://github.com/pylon-code/pylon/pull/321) |
| fix(client): explain possible network blocking for T3 Connect (#9783)                         | `2dca7a1eddd27c823e4d9d0a316864c4ad9f95c5` | [Pylon #324](https://github.com/pylon-code/pylon/pull/324) |
| fix(server): discover project skills for Codex and OpenCode (#8778)                           | `80a14b6588f0e856983e6d10002cde9e00e9d3e2` | [Pylon #310](https://github.com/pylon-code/pylon/pull/310) |
| fix(providers): discover workspace skills everywhere (#9180)                                  | `15fea6c5f40331c8325f33bd08b2dcbf924e935a` | [Pylon #310](https://github.com/pylon-code/pylon/pull/310) |
| fix(server): load OpenCode workspace skills via SDK to avoid 64KB CLI pipe truncation (#9585) | `2152d44de2db30a6bae965b0afd30be080e5c872` | [Pylon #310](https://github.com/pylon-code/pylon/pull/310) |
| fix(cursor): discover symlinked skills as package boundaries (#9420)                          | `087cfb8ae262f344f7e409f5a8c0eda6f0ef12f9` | [Pylon #310](https://github.com/pylon-code/pylon/pull/310) |
| fix(desktop): hold-to-quit no longer gets stuck (#9141)                                       | `b8262b41228e03b2e1e14b701be449034349c8ba` | [Pylon #311](https://github.com/pylon-code/pylon/pull/311) |
| fix(desktop): restore second-press quit fallback (#9485)                                      | `678f23a69943e3eef7171f452b44f2931d2ef21f` | Already present; not counted as a new adoption             |
| fix(desktop): quit immediately on a second shortcut press (#9657)                             | `caa8a0db98f9d32e98a1645caa7f7dd37b14f187` | [Pylon #311](https://github.com/pylon-code/pylon/pull/311) |
| fix(desktop): isolate preview keyboard shortcuts from the host (#9840)                        | `b5fb3fba0fb3dbd1bc2e29886232321cc06863d5` | [Pylon #312](https://github.com/pylon-code/pylon/pull/312) |
| fix(preview): bound automation waits and screenshot captures (#4685)                          | `de1b798c6ed4223cabd64f56eadcc8f512963043` | [Pylon #312](https://github.com/pylon-code/pylon/pull/312) |
| fix(server): preserve automatic settlement timestamps (#9254)                                 | `2971ec3209d7ef1b00d7ded70fe6342816b1539f` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): reuse pr state when settling threads (#9459)                                     | `c78f05a45e1c2b274d8b0ab2b4d2d88b4767c968` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): settle branch threads immediately on pull request merge (#9528)                  | `2b96220f00de09b61327c8e881b7f509f8cc5a79` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): find newly opened pull requests after agent turns (#9125)                        | `4e547318b60031eb546d8cf2b84ad9fa0785a87a` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(pull-requests): refresh data after thread turns (#9496)                                   | `5cc369b7eb882dbea8d5ad21ba688c73a0058748` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): settle inactive threads with open PRs (#9610)                                    | `d536b0580d044967dc644498d8c5a6e96464f767` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix: address usage limits and merge settlement regressions (#9784)                            | `98a29cbaa1ccf8d8afb6d35e3e1d925ff9b5fa90` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): settle threads using actual pull request terminal timestamps (#9934)             | `050690d1bc048c1f94096c17a1c9231c3ad61a83` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): settle inactive threads without a PR lookup (#10103)                             | `f66cfe2219e3f255f573f6430f9c989c58ed517d` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): capture checkpoints before refreshing PR status (#10347)                         | `e0adcc8a24db604c522282edea2823e3ef7a2bc6` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): link thread PRs without an open client (#10101)                                  | `223ff4490f764a74ff911589e97b9bbcd595fee8` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(server): keep attachments until the command commits (#7941)                               | `716069f40f000887cb01685099a16e19d9194307` | [Pylon #309](https://github.com/pylon-code/pylon/pull/309) |
| fix(web): unlock the composer when preview capture fails (#9127)                              | `19c97ea56d30b3a2de31a060f8f47d6b7404b78f` | [Pylon #312](https://github.com/pylon-code/pylon/pull/312) |
| fix(pull-requests): shared state + not settling? (#9332)                                      | `854541a04e07b7960698b381bcfd2fda73eb276c` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| fix(web): render draft PRs in gray (#9537)                                                    | `caab2fdbac041ac2e851ad4fa3ac4a40a1d4a8f6` | [Pylon #325](https://github.com/pylon-code/pylon/pull/325) |
| perf(web): defer composer draft serialization (#9695)                                         | `dab5f6e6e02e78675655e69503aa89654e5b8050` | [Pylon #330](https://github.com/pylon-code/pylon/pull/330) |
| perf(relay): avoid repeated activity decoding (#9708)                                         | `c75299ee2085a121bceb6df76796e971fe92b5b6` | [Pylon #328](https://github.com/pylon-code/pylon/pull/328) |
| perf(client): reduce thread-list update work (#9716)                                          | `c66f15f39e61fda0a9a100578833ec12e7526859` | [Pylon #327](https://github.com/pylon-code/pylon/pull/327) |
| perf(web): avoid repeated terminal metadata scans (#9747)                                     | `fec606f9ae524277ef1f6886e614f32d9e15e36e` | [Pylon #327](https://github.com/pylon-code/pylon/pull/327) |
| perf(server): skip unused Linux process detail reads (#9768)                                  | `163d86a78430d23414abde323ca70d8379280c0b` | [Pylon #329](https://github.com/pylon-code/pylon/pull/329) |

The 49-helper and 36-adaptation batches below list the remaining 85 source commits individually. DEF-11 through DEF-15 retain live Pylon callers. DEF-16 was resolved once workspace skills merged and is retired. DEF-7/DEF-8 and WATCH-1 through WATCH-3 retain their recorded revisit conditions; this catch-up does not silently accept their product or native-runtime changes.
...
Verification: both new regression cases failed before the port; all 183 tests across server routing, live budget, event coalescing, and activity projection passed afterward. The scoped server typecheck, targeted lint, and formatting passed. No UI layout or native dependency changes. Merged in [Pylon #333](https://github.com/pylon-code/pylon/pull/333) as `1e7ffff246bf6ad4c31236e6b242a91d5c2275b0`. Implementation branch: `upstream/2026-09-06-projected-live-stream-budget` from `origin/pylon` at `71b11a43bef90229c255c704dbbd8b368080b97c`.
...
| ----------------------------------------------------------------------------- | ------------------------------------------ | ----------------------------------- |
| test(mobile): keep composer selection helper private (#9953)                  | `a399473c30e6b451ec6348e52cbf9b4c4b07e505` | Adopted with Pylon-first adaptation |
| test(contracts): keep driver default lookup private (#9968)                   | `dfc70a3294641a2acb021766a759ac4c79665944` | Adopted with Pylon-first adaptation |
| refactor(mobile): remove unused layout calculations (#9974)                   | `eda0cec92398a4097958b55accaa59fdd178a977` | Adopted with Pylon-first adaptation |
| test(server): remove provider equality wrapper fixture (#9979)                | `2fc630c9e85321b7b3963372fd316877a7581639` | Adopted with Pylon-first adaptation |
| test(server): assert the dispatched welcome thread model (#9980)              | `1550f1b742138df8b31b24e34ddea58c80afb3cc` | Adopted with Pylon-first adaptation |
| refactor(desktop): remove unused keyring remediation text (#9981)             | `14da634577773d291c494635c1a4bcdb0e70f9ee` | Adopted with Pylon-first adaptation |
| refactor(desktop): remove test-only Electron error predicates (#9982)         | `a9caf7b7089afb6f1b3b888ea404b75b8f9e88e1` | Adopted with Pylon-first adaptation |
| test(server): remove authorization prompt snapshots (#9985)                   | `371e32392570fdc0d2309e9f92490bbd2c6b3f02` | Adopted with Pylon-first adaptation |
| test(server): remove provider label identity assertion (#9987)                | `9867eb12396439f58e03e3548e053d966f0f64a6` | Adopted with Pylon-first adaptation |
| test(server): consolidate agent activity opt-in coverage (#9988)              | `94d1fa7ff268e88476a341eb73f9f032e2af6a21` | Adopted with Pylon-first adaptation |
| refactor(shared): remove retired PATH capture parser (#9991)                  | `da1bebbb11701b58ebdde5ee019f3aeef3d42b27` | Adopted with Pylon-first adaptation |
| refactor(client-runtime): remove unused subagent selectors (#9992)            | `3bcde91f8215ec24eeffdd4abdee8fcb8a5e94f9` | Adopted with Pylon-first adaptation |
| refactor(web): remove obsolete cloud listing helpers (#9995)                  | `bf1c1b09756a56a0600faf52561f0fb4ae94e355` | Adopted with Pylon-first adaptation |
| test(server): cover raw OpenCode deltas through the adapter (#9977)           | `3fedf52467dd8d2734a7aca4c6c7da421c12474f` | Adopted with Pylon-first adaptation |
| refactor(server): remove test-only pricing normalizer (#10017)                | `270e021f2a7ed34e3d81d1cdc9f1ca0c0ac85df4` | Adopted with Pylon-first adaptation |
| refactor(web): test environment-scoped draft promotion (#10010)               | `82c2b7ffb4d450572f5baf9a70693f1e25cfdfed` | Adopted with Pylon-first adaptation |
| refactor(server): remove unused startup heartbeat launcher (#10030)           | `f5d9d12026d98b2b4b975f1944e7503d6c2c9eb3` | Adopted with Pylon-first adaptation |
| refactor(mobile): test composer persistence through the live decoder (#10033) | `83a2897ed6c400b3679a37920e964d829094bd43` | Adopted with Pylon-first adaptation |
| refactor(web): remove unused sidebar selectors (#10034)                       | `5cb696595cd66bb00e03fa5f91d9cd4273949f5b` | Adopted with Pylon-first adaptation |
| refactor(server): keep Cursor fallback models private (#10038)                | `ad3721eb5bec31066d162916f700107aab5e125b` | Adopted with Pylon-first adaptation |
| refactor(mobile): keep appearance calculations private (#10043)               | `5e828bf3de1c86d85afdd91a02cc4ca1a38d4aef` | Adopted with Pylon-first adaptation |
| test(server): exercise Codex prompts through public assembly (#10045)         | `df370c31d26afc72ace55263e746ba4386dada25` | Adopted with Pylon-first adaptation |
| refactor(shared): remove unused elapsed-time adapter (#10046)                 | `62e74cdd9a0aa4df5fc612d94193da9610129dc9` | Adopted with Pylon-first adaptation |
| refactor(web): remove obsolete HSL theme generator (#10061)                   | `80f775a42c448290c102e572fc889e4e4a1dd546` | Adopted with Pylon-first adaptation |
| refactor(mobile): remove obsolete native diff token stream (#10062)           | `d524eb96936090bd2b8a96449784155ad4af9591` | Adopted with Pylon-first adaptation |
| test(server): remove title prompt editorial snapshots (#10063)                | `bc24d98d1630104722abe6a4d839365d24e2aa27` | Adopted with Pylon-first adaptation |
| refactor(web): observe preview tests through the live registry (#10064)       | `43700b83e73fca3af7b63769876c409b5c6f5a3f` | Adopted with Pylon-first adaptation |
| test(server): remove keybinding default assignment snapshot (#10065)          | `fedf84ac7922e11be0971ac50817d7c4199b8e89` | Adopted with Pylon-first adaptation |
| refactor(mobile): remove obsolete whole-file review highlighters (#10067)     | `4db2c542a8c5e6b6756fac08615e30b220b71a2f` | Adopted with Pylon-first adaptation |
| refactor(web): test live keybinding resolvers directly (#10069)               | `009c13fade9dde2fe7eed068c72c579172f12e60` | Adopted with Pylon-first adaptation |
| test(web): remove mocked diff view prop snapshot (#10073)                     | `38812c101e562c4f8d9bea7b1a592a4b02954a39` | Adopted with Pylon-first adaptation |
| test(web): remove mocked annotation options snapshot (#10074)                 | `19ea3c5beb4cd93dd19f51f3e7c6d760357b41df` | Adopted with Pylon-first adaptation |
...
Outcome: merged in [Pylon #326](https://github.com/pylon-code/pylon/pull/326) as `3e87857f933864890dfe5fa115aa33c4a01756b3`, implemented on `upstream/2026-09-06-unused-helper-cleanup` from `origin/pylon` at `c145a1be76cfe577faceae16cc5e68d70d52278e`. Each source commit is cited by its cherry-pick trailer. Focused verification passed: 738 tests across 58 files; shared, client-runtime, Codex app-server, Tailscale, server, web, mobile, desktop and relay package typechecks; lint and formatting on 98 surviving changed files. No visible layout or motion changes require screenshots. No device build or deployment is claimed.
...
| Concern                                                        | Upstream commits                                                                                                                                                                                                                                          | Pylon outcome                                                                                                                                                                                                                                                                                                                                 |
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| B1 — stop rapid tunnel restart loops                           | #8788 `b90898077e60290a1eb7bea4224f325fd3bb1595`                                                                                                                                                                                                          | [290](https://github.com/pylon-code/pylon/pull/290) merged `10733dc268faa041c9051488c6dffc23b5d25770`                                                                                                                                                                                                                                         |
| B2 — bound slow-client buffers                                 | #9715 `108f295cc3672716c3cb8291ce487846df5ce098`                                                                                                                                                                                                          | [293](https://github.com/pylon-code/pylon/pull/293) merged `72629825724b716f6537246d02ebeab4b919a9c3`                                                                                                                                                                                                                                         |
| B3 — prevent desktop preview automation crashes                | #9068 `6319a9714881a1d25549f797c468fabebae92813`                                                                                                                                                                                                          | [291](https://github.com/pylon-code/pylon/pull/291) merged `e58f82c083c09da098e0316980d6e422b7ac382d`                                                                                                                                                                                                                                         |
| B4 — make missing workspaces and runtime errors understandable | #5040 `fce8508456e7f9218eebb02ecd764f9b3a47df6b`; #9885 `9cb40178a53cca279c67a9079afab3cddf6b6ddb`; #9870 `1246146f59a5a0f7a6f2da46bdd91f79b231d6a6`                                                                                                      | [300](https://github.com/pylon-code/pylon/pull/300) merged `c1c7e88f7b27d16496323a5be9e824075655a402`; [298](https://github.com/pylon-code/pylon/pull/298) merged `09f6666dfb5e58663a3d97ee417589a50733d589`; [304](https://github.com/pylon-code/pylon/pull/304) merged `c9668159495b88cbd21a166daee667ed33908686`; client evidence attached |
| B5 — clear native questions after their turn ends              | #9851 `d7fe47fd0957a34fc2e8bb05f12db19bac3403b6`                                                                                                                                                                                                          | [297](https://github.com/pylon-code/pylon/pull/297) merged `b787b7227a0e1e2e29e0c6bac88f2753ccfaf955`                                                                                                                                                                                                                                         |
| B6 — repair final checkpoints and Git transitions              | #9841 `7a089b2b2449c5c146e1a7d554a31e6d55924d3f`; #9842 `0dd5c64bcfac7974d81bac76740ecd83540077e8`; #10078 `c843c19294bcea9a4f5cf19632b135459a16d214`                                                                                                     | [305](https://github.com/pylon-code/pylon/pull/305) merged `072966850cdc6927dc46158a989a81727d27ba6f`                                                                                                                                                                                                                                         |
| B7 — update the installation that actually owns each provider  | #9850 `2d5464afbc19058be8c125d5ee70481d721d14f4`; #9856 `d28077e585d5123b9a562f4ebef257969c81aa31`; #9325 `2fb99a7a664faf045f1884f38c620016b34874cb`; #9927 `c7dc3cbd068a93c9fb5027df7bea719d16e4ffbe`; #10085 `2271a27dad1205b403a66af01461f856986e5064` | [303](https://github.com/pylon-code/pylon/pull/303) merged `69b75923665bab615ea0cf50186e2e46fc01795e`; client evidence attached                                                                                                                                                                                                               |
| B8 — keep file saves and editing reliable                      | #9878 `b01771c2383bbcdf154b8c4e9f1a7d5e3867e2d0`; #9902 `df8e0eb46bca3dc01c17cc74a53b19aaacbe252b`; #9947 `2fa5ef4c7bf3aafabe98392d25be7eb86847ce8f`; #9910 `3e1333319aacff96856a3c161b8787ff6b0ddd6b`                                                    | [301](https://github.com/pylon-code/pylon/pull/301) merged `d47e16cd572c06b1cf6f06933fb359748393bfb9`; client evidence attached                                                                                                                                                                                                               |
| B9 — recognize digit-leading skill names                       | #9244 `82f64cd8d046ab4ee8588f7bcbc1e66a4a0c80fe`                                                                                                                                                                                                          | [302](https://github.com/pylon-code/pylon/pull/302) merged `e049cbc967062162bf89aba59a4b74e88f93e1cd`; client evidence attached                                                                                                                                                                                                               |
| B10 — avoid repeated Cursor model discovery                    | #9918 `0d8a91a25a35618c7cae1e02791e491afa1f0a00`                                                                                                                                                                                                          | [296](https://github.com/pylon-code/pylon/pull/296) merged `a9937454129491445a535697fe85fb18ce4fd58d`                                                                                                                                                                                                                                         |
| B11 — respect OpenCode’s native rollback boundary              | #9924 `4ca71463a289e7b96b5776b6f6bbdecefe4757e4`                                                                                                                                                                                                          | [292](https://github.com/pylon-code/pylon/pull/292) merged `006e61b6c1f896ecfa2ff2afba9fd3655dc6a91c`                                                                                                                                                                                                                                         |
| B12 — release stalled Apple notification deliveries            | #9734 `088cc3f95599b7b933289d719fa1e9b0608cb4cd`                                                                                                                                                                                                          | [295](https://github.com/pylon-code/pylon/pull/295) merged `276fe3a096c7babe34c9cb6b87aa3ca8e01f25f3`                                                                                                                                                                                                                                         |
| B13 — make launcher file flushes work on Windows               | #9569 `f083f520fbde1e1bf4332399df47b45c2bd99722`                                                                                                                                                                                                          | [299](https://github.com/pylon-code/pylon/pull/299) merged `137b95dba73caee3790727483f2e5261bd28cec8`                                                                                                                                                                                                                                         |
| B14 — align tool.denied event typing                           | #9770 `b7d6e65021b021207424c56cb32d6d711fd875fb`                                                                                                                                                                                                          | [294](https://github.com/pylon-code/pylon/pull/294) merged `f0cf7eba1d477ef43e641ed44209d84bb3e76c08`                                                                                                                                                                                                                                         |

Pylon adaptations preserve desktop identity and runtime directories, native Prime admission/incarnation fences and managed distributions, immutable rollback anchors and the durable rollback saga, the current Pierre version, and mobile’s independent renderer. Missing Cursor skill-discovery and other unselected parent features were not imported. APNs changes are relay source changes and require a separate relay deployment.

Validation uses focused tests and scoped package typechecks. Shared service tests cover missing/restored workspaces; ingestion tests cover terminal native questions and stale incarnations; 240 checkpoint/projection/rollback tests cover terminal capture, nested workspaces and Git initialization. Provider maintenance tests use disposable executable layouts and fake commands; no installed CLI was updated. The new editor tests exercise effect replay, language readiness and deterministic worker replies. The combined branch passed 303 focused tests across nine files and both server/web typechecks. In an isolated Chromium client, the baseline editor displayed an edit without saving it; the repaired editor saved it to disk and retained it after switching files. Rendered Markdown correctly switches between two files. `$2spec` becomes a skill chip while `$20k` remains plain text, retained runtime diagnostics become visible, and manual-only provider updates expose installer guidance without offering an automatic update action. Server providers remain disabled; only client snapshots use synthetic skill/version data. Screenshots and short videos are outside the worktree. Evidence was subsequently uploaded through the signed-in GitHub browser, and all four UI PRs merged on September 6.

This section records source adoption. Nightly, hosted web, relay deployment and installed applications are distinct publication states. Nightly `0.0.33-nightly.20260906.125` was published from `072966850cdc6927dc46158a989a81727d27ba6f` by build 34037586207 with the 14 merged fixes. All four desktop builds and release-quality checks passed; both Mac builds were notarized. All three updater manifests reference the six expected payloads with matching published sizes and well-formed SHA-512 values. The source tag resolves to the selected product commit. Hosted web has a separate deployment job. The four UI PRs contain the other 11 selected fixes.
...
newly selected commits below, and 471 still unselected. All three selected changes are now merged; selection and merge are not claims of publication.
...
| N2 — let Authorized Clients scrolling reach Settings | #10080 `3da9399b1ac4e015f8db29c49718a74c57e62e83` | [#287](https://github.com/pylon-code/pylon/pull/287) merged `76e31d7775f0b8baf6a6f82e5961291de3c1a2a7`; CI and integrated client verification passed; evidence attached. |
| N3 — respect reduced motion in shared disclosures    | #10258 `84aebb72f306f17bed680e1241dab9ab8e8df741` | [#288](https://github.com/pylon-code/pylon/pull/288) merged `74211a581c499d2caab10b7641dfffdad5ba8e29`; CI and integrated client verification passed; evidence attached. |
...
were captured outside the source tree. The initial Mac lock interrupted upload; evidence was later attached and #287/#288 merged after green CI.
...
The recovered work comprises the still-open PR hub and Astra PRs, the interrupted
OpenCode approval/Stop series, and the older OpenCode task-progress intent in #178.
Upstream was refreshed through `bfba7781681eaa03eb465ce3d9a4ec07bf952b78`.
The full review cursor remains `beae2147a9487ec47ac992319f2216914b4cb62d`.

| Concern                                             | Upstream commits                                                                                                                                     | Pylon outcome                                                                                                                                                                                 |
| --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Astra model classification and public feeds         | #9762 `bc03c3640d6d3bb44e5fb477bfd78d7484cd0e00`                                                                                                     | #270 merged; #280 repairs checkout. Publication run 34010607556 succeeded; both public feeds at pylon-releases `4f071d502a24cb2b86cf4b44efb4f543c7a777cd` exactly match the validated source. |
| Cached desktop resource monitor                     | #9184 `7a8df3338f910cd18543cd3ea98b8b10385e8dcd`                                                                                                     | Split from #269, merged as #281 with green CI.                                                                                                                                                |
| OpenCode approvals, output, Stop, and task progress | #9005 `62d39bf00d5ddd83a9b36a81321fe9aa4d2502bb`; #9282 `d2b6f3b9296f682c6158b894ab33d98d0c4bfb2b`; #9653 `01f3e50eca5102ccd881de6f942a98fe6a518ad4` | #283 merged with green CI as `fa6da65b1444321810e77a9aa714d72c1920ba80`; #178 closed as superseded.                                                                                           |
| PR hub controls and retained details                | #9188 `443b4ebfe83fcfe64c34b09ecb5a5fffdebb85c7`; #9334 `2a3cfe456375fd34b906f849b04706109dc74170`; #9294 `d897641d738c67dd7c12cbb3a273b43fe17a5eb1` | #269 rebased and verified; green CI. Browser permission or an explicit visual-evidence waiver remains pending.                                                                                |
| Chat scroll-to-end visibility                       | #9280 `c742edd46c5b6792ec8647f934a4703f9103aa82`                                                                                                     | Split from #269 into #282; green CI. Browser/video permission or an explicit evidence waiver remains pending.                                                                                 |

OpenCode preserves Pylon's incarnation and admission fencing and compaction events.
Workspace permission scope uses the existing detail field on all clients, without
importing upstream's incompatible approval-option field. Plans are parent-only,
active-turn-only, deduplicated, and omit cancelled tasks. The output-drain regression
uses a real subprocess; the legacy turn fixture now follows Pylon's admitted start
path. All 400 focused tests pass across nine files; server, web, mobile, and shared
client-runtime typechecks, targeted lint, and formatting pass.

PR hub verification includes 612 tests and all six affected package typechecks.
Pylon-specific regressions prevent denied browser storage from crashing the detail
panel and prevent a cached PR from crossing environment boundaries. The scrolling
fix passes 44 tests and web typecheck; the desktop build fix passes 78 tests and
scripts typecheck. No browser, simulator, live provider session, or production
state was used in these checks.

The original 555-commit inventory now has five further upstream commits (560 total).
All eight selected commits inside that range were originally unmatched; #9005 is
an older missing dependency outside the range. After those eight land, 448 remain
unselected for assessment. Four selected UI commits are still pending separately;
they are not silently marked landed. Inventory evidence is not a claim that every
upstream change belongs in Pylon.
...
Pylon schemes, production/preview fingerprints, and current Tailwind 4.3.0; review
#9355 before any Tailwind 4.3.3 adoption with Uniwind 1.11. Keep native-menu, navigation,
and shared connection-scope work separate for native verification. No new approval
is inferred. WATCH-1 #8097 remains open/unmerged; owner #114 records that #283 closed
the OpenCode gap and superseded #178. WATCH-2 #6573 and WATCH-3 #7966/#7986 remain closed with no replacement
in the newly checked paths, retaining their November 1 floors. No entries were added.
