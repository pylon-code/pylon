...
`upstream/2026-08-13-pr-surfaces` (PR #13) sits on top of it.

| Change set | Upstream                                      | Decision | Pylon reference          | Rationale or revisit condition                                                                                                                                                                                                                                                             |
| ---------- | --------------------------------------------- | -------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| P1         | `b28f9bf0a` / `#6039`                         | adopted  | PR #13 / `a4dd4e5cc`     | Pull request surfaces: filters and qualifiers, all-server listing, update branch, reactions, in-place title/description/comment editing, checks popover, smarter diff file ordering. 86 files, +11,929, across contracts, all four PR providers, and web. One conflict only — see below.   |
| P2         | `92d4a2e99` / `#6490`                         | adopted  | PR #13 / `478e09712`     | Scopes pull request errors to their environment, which only has meaning once the list spans several. Depended on `P1`: it conflicts in exactly the four files `P1` rewrites, and applied clean once `P1` was in.                                                                           |
