...
| U5b  | `7068e86f7` / `#8507`                        | adopted with adaptation | `d7109b3ec`, `#134`               | "Open on GitHub" when the pull request API fails. One docs conflict resolved Pylon-first; upstream's copy named T3 Code twice.                                                                                                                                                                                                                                |
...
| U8   | `49f6241dd` / `#8502`                        | adopted with adaptation | `03db9fab3`, `#136`               | Codex sub-agent models. Two child-identity conflicts; Pylon's `toolUseId` kept at the call site because it names the live turn, not the child. Both halves mutation-probed.                                                                                                                                                                                   |
...
| U10  | `8f4913221` / `#8235`                        | adopted with adaptation | `70d4fb32c`, `#140`               | File uploads to 50 MiB. Both of Pylon's Prime adapters needed the image-only guard upstream gave its five, or a PDF would have been base64'd as an ACP image block. The daemon adapter was missed until review. Ships tests upstream never wrote.                                                                                                             |
...
| U12  | `018d7f277` / `#7327`                        | adopted with adaptation | `4c18d15f9` + `a23ada2e5`, `#138` | Mobile semantic themes compiled for Uniwind. Six conflicts; `T3Wordmark` stays deleted and `PylonMark` gains the same idiom. Also converted three Pylon-only files the new lint rule rejected at error severity.                                                                                                                                              |
