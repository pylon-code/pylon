# Web launch and pairing

Paths and commands are relative to repository root.
...
- If the pairing URL is no longer visible, use the `pair` command above against the running server's exact base directory.
