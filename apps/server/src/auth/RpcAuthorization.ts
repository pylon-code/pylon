...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.providerRespondToInteraction]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerAskSessionSideQuestion]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerCancelSessionSideQuestion]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerCancelSessionAgent]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerMessageSessionAgent]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerWatchSessionAgentActivity]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.providerRemoveOnlySessionInputQueueItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerSetSessionInputQueueMode]: AuthOrchestrationOperateScope,
  [WS_METHODS.providerGetSessionCompaction]: AuthOrchestrationReadScope,
  [WS_METHODS.providerCompactSession]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.computerSetupSubscribe]: AuthOrchestrationReadScope,
  [WS_METHODS.computerSetupRefresh]: AuthOrchestrationReadScope,
  [WS_METHODS.computerSetupStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.computerSetupCancel]: AuthOrchestrationOperateScope,
