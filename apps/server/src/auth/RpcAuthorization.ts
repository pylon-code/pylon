...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.kanbanCreateWorkItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.kanbanUpdateWorkItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.kanbanMoveWorkItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.kanbanArchiveWorkItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.kanbanRestoreWorkItem]: AuthOrchestrationOperateScope,
  [WS_METHODS.kanbanSubscribe]: AuthOrchestrationReadScope,
