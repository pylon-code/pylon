...
const LINUX_DIRECTORY_HANDLER_PROBE_FORCE_KILL_AFTER = "1 second";
const LINUX_DIRECTORY_HANDLER_PROBE_MAX_STDOUT_BYTES = 1024;
    ...
    return yield* spawner
      .spawn(
        ChildProcess.make("xdg-mime", ["query", "default", "inode/directory"], {
          ...
          env,
          extendEnv: true,
          forceKillAfter: LINUX_DIRECTORY_HANDLER_PROBE_FORCE_KILL_AFTER,
        }),
      )
      .pipe(
          ...
          Effect.all(
            [
              collectUint8StreamText({
                ...
                maxBytes: LINUX_DIRECTORY_HANDLER_PROBE_MAX_STDOUT_BYTES,
              }),
              handle.exitCode,
            ],
