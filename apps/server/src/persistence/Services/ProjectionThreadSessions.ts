...
export const ProjectionThreadSession = Schema.Struct({
  ...
  pendingStopRequestId: Schema.NullOr(CommandId),
  pendingStopProviderInstanceId: Schema.NullOr(ProviderInstanceId),
  pendingStopSessionIncarnationId: Schema.NullOr(RuntimeSessionId),
  pendingStopTurnRequestId: Schema.NullOr(CommandId),
  pendingStopTurnId: Schema.NullOr(TurnId),
