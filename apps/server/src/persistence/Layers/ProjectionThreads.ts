    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.snoozedAt},
          ${row.pinnedAt},
          ${row.continuedFromThreadId ?? null},
        ...
        DO UPDATE SET
          ...
          rollback_updated_at = excluded.rollback_updated_at,
          ...
          continued_from_thread_id = excluded.continued_from_thread_id,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          continued_from_thread_id AS "continuedFromThreadId",
