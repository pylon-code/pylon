...
import Migration0054 from "./Migrations/054_RepairAutomaticSettlementTimestamps.ts";
...
export const migrationEntries = [
  ...
  // Upstream shipped this as 40, immediately after its own 39 (#5766). Pylon's
  ...
  // Upstream shipped this as 42 (pingdotgg/t3code#8160). Pylon already holds 42
  ...
  // Upstream shipped this as 46 (#9254); Pylon already uses ids through 53.
  [54, "RepairAutomaticSettlementTimestamps", Migration0054],
  // Upstream shipped this as 48 (#10101); Pylon already uses ids through 54.
  [55, "ProjectionThreadBranchPullRequest", Migration0055],
  // Upstream #9137 used 47; Pylon reserves its existing migration lineage.
