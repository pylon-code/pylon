...
const makeProviderService = (liveThreadIds: ReadonlyArray<ThreadId> = []) =>
  ({
    ...
    respondToInteraction: () => Effect.die("unused"),
    reloadSessionResources: () => Effect.die("unused"),
    askSessionSideQuestion: () => Effect.die("unused"),
    cancelSessionSideQuestion: () => Effect.die("unused"),
    cancelSessionAgent: () => Effect.die("unused"),
    messageSessionAgent: () => Effect.die("unused"),
    watchSessionAgentActivity: () => Stream.empty,
    getSessionAgentDepth: () => Effect.die("unused"),
    setSessionAgentDepth: () => Effect.die("unused"),
    followUp: () => Effect.die("unused"),
    getSessionInputQueue: () => Effect.die("unused"),
    clearSessionInputQueue: () => Effect.die("unused"),
    removeOnlySessionInputQueueItem: () => Effect.die("unused"),
    setSessionInputQueueMode: () => Effect.die("unused"),
    getSessionCompaction: () => Effect.die("unused"),
    compactSession: () => Effect.die("unused"),
    abortSessionCompaction: () => Effect.die("unused"),
    setSessionAutoCompaction: () => Effect.die("unused"),
    refineSessionHarness: () => Effect.die("unused"),
