...
export const PRIME_AGENT_MULTIPLE_INSTANCES_UNAVAILABLE_REASON =
  "Multiple Prime Agent instances are unavailable with Prime Agent 0.8.1: ACP uses one OS-user daemon socket, and concurrent public-SDK daemon roots did not pass A/B isolation. Use separate Pylon server environments for separate Prime accounts.";
