  ...
  Effect.gen(function* () {
    ...
    const interceptCollabChildNotification = (notification: CodexServerNotification) =>
      Effect.gen(function* () {
        ...
        // `collabChildIdentity` covers the static identity plus model/effort.
        // `toolUseId` stays at the call site because it names the child's live
        // turn, not the child, and `turn/started` below overrides it with the
        // turn id the notification itself carries.
        const childIdentity = {
