...
/**
 * Client captured the plan for Pylon's proposed-plan card. Abandon the native
 * Grok plan-approval gate so the turn unblocks; the user implements via the Pylon UI.
 */
 ...
 * Used so Pylon can show the plan while plan mode is still active (before exit).
 */
