...
describe("openTerminalLinkInPreview", () => {
  ...
  it("falls back when the preview bridge rejects", async () => {
    const cause = new Error("bridge disconnected");
    const fallbackToBrowser = vi.fn();
