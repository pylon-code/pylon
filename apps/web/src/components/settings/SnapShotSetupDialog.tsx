...
const GNOME_ACCESS_COPY = {
  "not-installed": {
    ...
    description:
      "The Pylon GNOME extension lets you capture other windows and bring them into your draft. Sign out once after installing.",
  },
  "restart-required": {
  ...
  disabled: {
    ...
    description: "Enable Pylon SnapShots to start capturing windows.",
  },
  enabled: {
  ...
  error: {
    ...
    description: "Check Pylon SnapShots in GNOME Extensions, then try again.",
  },
};
              ...
              : {
                  title:
                    helper?.status === "update-required"
                      ...
                      : "Allow snapshots",
                  description:
                    "Pylon's capture helper lets you capture other apps and return to your draft. It's included with Pylon.",
                }
          : backend === "niri"
            ? {
                title: "Capture is ready",
              ...
              <details className="text-xs text-muted-foreground">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  {step === "access" && (backend === "gnome" || helperBackend) ? (
                    <p>Included with Pylon. No download needed.</p>
                  ) : null}
