...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["composer meter usage tokens circle context window"],
  },
  {
...

  {
    ...
    to: "/settings/general",
    searchTerms: ["notify alert agent attention background native os"],
    desktopOnly: true,
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["notification approval permission agent waiting"],
    desktopOnly: true,
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["notification input question agent waiting"],
    desktopOnly: true,
  },
  {
    id: "desktop-notifications-completion",
    title: "Notify when an agent finishes",
    to: "/settings/general",
    searchTerms: ["notification finished completed done turn"],
    desktopOnly: true,
  },
  {
    id: "desktop-notifications-failure",
    title: "Notify when an agent fails",
    to: "/settings/general",
    searchTerms: ["notification failed error crashed"],
    desktopOnly: true,
  },
  {
  ...
  },
  {
    ...
    to: "/settings/general",
    searchTerms: ["notification test check working permission macos"],
    desktopOnly: true,
  },
  {
