...
import {
  getProjectEnvironmentPresentation,
  ProjectEnvironmentBadge,
} from "./ProjectEnvironmentBadge";
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
      ...
      >
        ...
        >
          ...
          >
            ...
            {prBadge}
            {hasUnsentDraft && !sortable?.isDragging ? (
              <Tooltip>
                <TooltipTrigger
                  render={
                    <button
  ...
  const CompactStatusIcon =
    topStatus && topStatus.icon !== null
      ? {
          working: CircleDashedIcon,
          delegating: GitForkIcon,
          monitoring: EyeIcon,
                      ...
                      isWokeStatus ? (
                        ...
                        >
                          {topStatus.icon === "working" ? (
                            ...
                            <GitForkIcon aria-hidden className="size-4 shrink-0" />
          ...
          render={
            <button
              ...
              className={cn(
                ...
                compact && "h-9 min-h-0 justify-center px-0 py-0",
                props.isHighlighted || props.isRouteActive
                  ? "bg-sidebar-row-active text-sidebar-foreground"
                  : "text-sidebar-muted-foreground/75 hover:bg-sidebar-row-hover hover:text-sidebar-foreground",
                isFileDragOver && "ring-1 ring-inset ring-primary/70",
        ...
        >
          ...
          {compact ? (
            <>
              ...
              <span className="sr-only">{threadTimeLabel(thread)}</span>
            </>
          ) : (
...
export default function Sidebar() {
  ...
  // Safari may dispatch a selection click after the context menu opens settings.
                          ...
                          scopedProjectGroup
                            ? `Filter threads by project: ${scopedProjectGroup.displayName}${
                                showProjectEnvironments
                                  ? ` — ${getProjectEnvironmentPresentation(scopedProjectGroup.memberProjects, primaryEnvironmentId)?.description ?? "On this machine"}`
                                  : ""
                              }`
