...
export function DeviceStreamView(props: {
  ...
  const visible = props.visible && foreground;
  ...
  }, [access, onHandle, onScreen, props.deviceId, props.environmentId, props.platform, visible]);
  ...
  useEffect(() => {
    if (!props.axOverlay || !access || !visible) return;
  ...
  }, [access, props.axOverlay, props.deviceId, props.platform, visible]);
