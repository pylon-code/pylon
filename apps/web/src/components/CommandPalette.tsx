  ...
  useEffect(() => {
    const onKeyDown = (event: globalThis.KeyboardEvent) => {
      ...
      if (command === "appearance.cycle") {
        ...
        const nextMode = nextAppearanceMode(appearanceMode);
...
function OpenCommandPaletteDialog(props: {
  ...
  const detectedPullRequestUrl =
    activeThread == null || activeThreadPullRequest !== null
      ? null
      : (ThreadPr.resolveDisplayedThreadPr({
          threadBranch: activeThread.branch,
          branchPullRequest: activeThread.branchPullRequest,
  ...
  const handleAddProjectForEnvironment = useCallback(
    async (input: {
      ...
      if (existing) {
        const latestThread = getExistingThreadForProjectAdd(
