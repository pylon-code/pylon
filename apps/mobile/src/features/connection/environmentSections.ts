...
/**
 * Ids of the environments that already occupy a relay-managed cloud slot. A backend
 * saved directly is not one of them, so it must not suppress the cloud environment
