          ...
          <View className="min-w-0 flex-1 gap-0.5">
            ...
            {failedLabels.length > 0 ? (
              <Text className="text-sm font-t3-medium text-warning-foreground">
                {failedLabels.join(", ")} could not refresh limits.
                {pools.length > 0 ? " Showing available limits." : ""} Pull down to try again.
              </Text>
            ) : null}
            {failedLabels.length === 0 && notices.length > 0 ? (
              <Text className="text-sm text-warning-foreground">Pull down to try again.</Text>
            ) : null}
          </View>
        </View>
      ) : null}
