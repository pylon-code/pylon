...
function SubscriptionUsage(
  ...
  // Budget short cards for two quotas per provider, including secondary text.
  ...
  const providers = props.providers ?? [
    { name: "Codex", detail: "Open Pylon to connect", windows: [], expiresAt: 0 },
    { name: "Claude", detail: "Open Pylon to connect", windows: [], expiresAt: 0 },
  ];
