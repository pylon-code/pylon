...
describe("WSL runtime cache", () => {
  ...
  it("parses only absolute Linux runtime paths", () => {
    expect(parseWslRuntimeRoot("runtimeRoot:/home/josh/.pylon-code/wsl-runtime/1.2.3-x64\n")).toBe(
      "/home/josh/.pylon-code/wsl-runtime/1.2.3-x64",
    );
...
describe.skipIf(posixShellRunner === null)("WSL runtime install script (executed)", () => {
  ...
  const createFixture = () => {
    ...
    return {
      ...
      archiveSha,
      runtimeId,
      runtimeParent: `${work}/home/.pylon-code/wsl-runtime`,
      runtimeRoot: `${work}/home/.pylon-code/wsl-runtime/${runtimeId}`,
      serverEntry: `${work}/home/.pylon-code/wsl-runtime/${runtimeId}/apps/server/dist/bin.mjs`,
      installScript,
  ...
  it("prunes old and markerless caches without touching retained, active, locked, or unrelated roots", () => {
    const result = runShell(
      [
        ...
        "work=$(mktemp -d)",
        'home="$work/home"',
        'runtime_parent="$home/.pylon-code/wsl-runtime"',
