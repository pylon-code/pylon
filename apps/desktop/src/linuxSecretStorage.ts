...
function getGnomeKeyringRemediationMessage(): string {
  return "Pylon could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Pylon.";
}

function getKWalletRemediationMessage(): string {
  return "Pylon could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Pylon.";
}
