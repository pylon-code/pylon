...
const NAME = "org.gnome.Shell.Extensions.PylonSnapShot";
const PATH = "/org/gnome/Shell/Extensions/PylonSnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Pylon capture preview unavailable: ${error.message}`);
    }
  }
...
export default class PylonSnapShotExtension extends Extension {
  enable() {
