...
// One extension serves every installed Pylon channel; each owns `<app-id>.SnapShot`.
export const CLIENT_NAMES = [
  "com.pylon.code.SnapShot",
  "com.pylon.code.nightly.SnapShot",
  "com.pylon.code.dev.SnapShot",
];
...
export class CaptureService {
  ...
  async capture(sender, options) {
    ...
    try {
      ...
      if (!allowed) throw new Error("Only Pylon may request a snapshot.");
