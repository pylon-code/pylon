...
export const DESKTOP_FILE_EXCLUSIONS = [
  // Pylon always passes the user's installed Claude executable to the SDK,
...
export const resolveGitHubPublishConfig = Effect.fn("resolveGitHubPublishConfig")(function* (
  ...
  const env = yield* Config.all({
    updateRepository: Config.string("PYLON_DESKTOP_UPDATE_REPOSITORY").pipe(Config.option),
...
export const createBuildConfig = Effect.fn("createBuildConfig")(function* (
    ...
    buildConfig.mac = {
      ...
      extendInfo: {
        NSScreenCaptureUsageDescription:
          "Pylon captures the active window when you use the window capture shortcut.",
      },
      protocols: [
        {
          name: "Pylon",
  ...
  if (platform === "linux") {
    buildConfig.linux = {
      target: [target],
      executableName: "pylon",
      icon: "icons",
      category: "Development",
      // electron-builder turns these into MimeType=x-scheme-handler/<scheme>;
      // in the .desktop entry (Exec already gets %U), so browsers can hand
      // pylon-code:// OAuth callbacks to the app.
      protocols: [
        {
          name: "Pylon",
          schemes: ["pylon-code"],
...
const buildDesktopArtifactCli = Command.make("build-desktop-artifact", {
  ...
  Command.withDescription("Build a desktop artifact for Pylon."),
