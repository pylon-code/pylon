...
it("batches codesign calls without changing existing signing options", async () => {
  const options = {
    app: "/tmp/Pylon.app",
    identity: "Developer ID Application: Pylon",
    keychain: "/tmp/pylon.keychain",
    provisioningProfile: "/tmp/pylon.provisionprofile",
    optionsForFile: () => ({
      entitlements: "/tmp/pylon.entitlements.plist",
