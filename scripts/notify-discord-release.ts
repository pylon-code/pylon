  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Pylon prerelease is available for nightly testers."
          : "A new Pylon latest release is available.",
...
).pipe(Command.withDescription("Post a Pylon release announcement to Discord."));
