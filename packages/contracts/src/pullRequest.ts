 ...
 * this server's record for a host that keeps none, shared by clients of that environment.
 */
...
export const PullRequestInvalidateInput = Schema.Struct({
  ...
  /** Refresh review progress in this environment without discarding the patch. */
