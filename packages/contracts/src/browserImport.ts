 ...
 * machine into a Pylon browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Pylon profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Pylon Full Disk Access in System Settings → Privacy & Security, then retry.",
