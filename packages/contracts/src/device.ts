 ...
 *
 * Devices live on a host: the machine running the server or a configured SSH
 * host. Host ids scope every target and session so concurrent hosts remain
 * independent throughout discovery, streaming, and agent control.
 *
 * @module Device
 */
