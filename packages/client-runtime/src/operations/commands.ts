...
export type FollowUpThreadInputQueueInput = CommandInput<"thread.input-queue.follow-up">;
export type InterruptThreadTurnInput = CommandInput<"thread.turn.interrupt">;
export type RespondToThreadApprovalInput = CommandInput<"thread.approval.respond">;
export type RespondToThreadUserInputInput = CommandInput<"thread.user-input.respond">;
export type RespondToThreadInteractionInput = CommandInput<"thread.interaction.respond">;
...
export const followUpThreadInputQueue: (input: FollowUpThreadInputQueueInput) => CommandEffect =
  Effect.fn("EnvironmentCommands.followUpThreadInputQueue")(function* (input) {
    const metadata = yield* timestampedCommandMetadata(input);
    return yield* dispatch({
      ...input,
...
export const respondToThreadInteraction: (input: RespondToThreadInteractionInput) => CommandEffect =
  Effect.fn("EnvironmentCommands.respondToThreadInteraction")(function* (input) {
    const metadata = yield* timestampedCommandMetadata(input);
    return yield* dispatch({
      ...input,
