...
import {
  ...
  type RespondToThreadInteractionInput,
...
export type {
  ...
  RespondToThreadInteractionInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    respondToInteraction: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:respond-to-interaction",
      execute: (input: RespondToThreadInteractionInput) => respondToThreadInteraction(input),
      scheduler,
      concurrency,
    }),
