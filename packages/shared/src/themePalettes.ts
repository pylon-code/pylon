...
export const T3_CHAT_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    statusActive: "oklch(0.510938 0.086055 186.391)",
    statusInfo: "oklch(0.47267 0.221581 302.331)",
  ...
  variants: {
    dark: {
      ...
      statusActive: "oklch(0.78452 0.132529 181.912)",
      statusInfo: "oklch(0.902359 0.060408 306.703)",
...
export const GROVE_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    statusActive: "oklch(0.488198 0.217165 264.376)",
    statusInfo: "oklch(0.47267 0.221581 302.331)",
  ...
  variants: {
    dark: {
      ...
      statusActive: "oklch(0.71374 0.143381 254.624)",
      statusInfo: "oklch(0.902359 0.060408 306.703)",
...
export const OCEAN_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    statusActive: "oklch(0.519759 0.093565 223.128)",
    statusInfo: "oklch(0.47267 0.221581 302.331)",
  ...
  variants: {
    dark: {
      ...
      statusActive: "oklch(0.797116 0.133888 211.53)",
      statusInfo: "oklch(0.902359 0.060408 306.703)",
...
export const EMBER_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    statusActive: "oklch(0.443376 0.100033 240.79)",
    statusInfo: "oklch(0.47267 0.221581 302.331)",
  ...
  variants: {
    dark: {
      ...
      statusActive: "oklch(0.827586 0.101277 230.318)",
      statusInfo: "oklch(0.902359 0.060408 306.703)",
...
export const IRIS_THEME: ThemeDefinition = {
  ...
  colors: {
    ...
    statusActive: "oklch(0.499982 0.11929 242.749)",
    statusInfo: "oklch(0.47267 0.221581 302.331)",
  ...
  variants: {
    dark: {
      ...
      statusActive: "oklch(0.753513 0.138989 232.661)",
      statusInfo: "oklch(0.902359 0.060408 306.703)",
