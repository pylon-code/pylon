...
On web and desktop, groups of tools that finish after the final reply stay below that reply, followed by the timestamp and any reported cost. A single ordinary trailing call stays in the completed-work fold; failures and agent cards remain visible. Agent summaries follow the interface font size.
