...
and extracts that archive into `~/.pylon-code/wsl-runtime/sha256-<archive-digest>` inside
...
10. Complete the Clerk Native API and AASA setup in [Pylon Connect setup](./connect-setup.md#desktop-passkeys).
