...
Sent attachments and file links stream from the first signed asset URL for the
lifetime of the preview; following credential refreshes reactively would restart
playback. Composer drafts play from their retained local file instead. Quick Look copies
