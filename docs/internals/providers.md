...
closed to ACP compatibility mode because Prime Agent 0.7.3 does not expose a verifiable named-pipe
...
composer control. Prime Agent 0.7.3 exposes no corresponding daemon methods for create, update,
