...
> [!NOTE]
> Sign in to Pylon Connect from the app under Settings > Connections.

The relay is the hosted control plane for Pylon Connect. It helps clients discover and connect to
...
See the [Pylon Connect architecture overview](../../docs/internals/t3-code-connect-auth-flow.html) for the larger system
design.
...
stable and nightly clients. Every other stage references that project and forks an isolated
copy-on-write Neon branch for local development, so deploy `prod` before creating
developer stages:
...
- [Pylon Connect Clerk Setup](../../docs/internals/t3-connect.md) for Clerk keys, JWT templates, and sign-up restrictions
  setup.
- [Relay Observability](../../docs/operations/relay-observability.md) for deployment tracing and diagnostics.
- [Pylon Connect Architecture Overview](../../docs/internals/t3-code-connect-auth-flow.html) for the full link,
