# Prisma Website: Static site

Deploys a real Static site application with `Prisma.Website.StaticSite`.

A plain HTML/TypeScript application built by Vite through `StaticSite`'s shell-build API. The page increments a counter and fetches a static JSON asset.
