...
export default async function HomePage() {
  ...
  // way to reach env values from RSC page modules. On Prisma it is backed by
  // the Prisma Compute runtime's `process.env`.
...
// Dynamic: rendered by the Prisma Compute runtime at request time.
