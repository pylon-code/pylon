# Prisma Website: SolidStart

Deploys a real SolidStart application with `Prisma.Website.SolidStart`.

A SolidStart SSR page and a reactive counter call `/api/hello`, which reads `GREETING` at request time.
