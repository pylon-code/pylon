# Prisma Website: React Router

Deploys a real React Router application with `Prisma.Website.ReactRouter`.

A React Router server loader reads `GREETING`. The hydrated counter calls a resource route at `/api/hello`.
