# Prisma Website: TanStack Start

Deploys a real TanStack Start application with `Prisma.Website.TanStackStart`.

A TanStack Start server function supplies the SSR greeting. A hydrated React counter calls a server route at `/api/hello`.
