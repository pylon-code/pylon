# Prisma Website: Foldkit

Deploys a real Foldkit application with `Prisma.Website.Foldkit`.

A Foldkit model/update/view application with increment, decrement, and reset controls. The Vite plugin builds the real browser app.
...
For browser validation, open the returned URL. Click **+**, **-**, and **Reset**; the number changes and resets to zero.
