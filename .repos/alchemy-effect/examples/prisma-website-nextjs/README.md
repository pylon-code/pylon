# Prisma Website: Next.js

Deploys a real Next.js application with `Prisma.Website.Nextjs`.

An App Router page reads `GREETING` on each request. A client component increments a counter and calls `/api/hello` without a database.
