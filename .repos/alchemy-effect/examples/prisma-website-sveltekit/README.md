# Prisma Website: SvelteKit

Deploys a real SvelteKit application with `Prisma.Website.SvelteKit`.

A SvelteKit server loader reads `GREETING`. A hydrated counter calls `/api/hello`; `/about` is prerendered.
